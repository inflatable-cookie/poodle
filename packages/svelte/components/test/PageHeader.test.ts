...
describe("PageHeader (svelte)", () => {
  ...
  it("renders the eyebrow, section, and subtitle in the default posture", () => {
    const { container } = render(PageHeader, {
      props: { title: "Button", section: "Primitive", eyebrow: "Foundation", subtitle: "Primary control." },
    });
  ...
  it("renders the count badge through the Pill primitive", () => {
    const { container } = render(PageHeader, { props: { title: "Components", count: 42 } });
  ...
  it("renders the back link with the resolved display label and context dot", () => {
    const { container } = render(PageHeader, {
      props: { title: "Members", backHref: "/settings", backLabel: "Back to settings", backIsContextual: true },
    });
  ...
  it("renders the banner message through a polite Callout", () => {
    const { container } = render(PageHeader, {
      props: { title: "Members", bannerMessage: "Read-only view" },
    });
  ...
  it("renders the actions region when an actions snippet is provided", () => {
    const { container } = render(PageHeader, {
      props: { title: "Members", actions: asSnippet(() => "<button>Edit</button>") },
    });
  ...
  it("swaps section and title in the entity-detail posture", () => {
    const { container } = render(PageHeader, {
      props: { title: "Member name", section: "Members", posture: "entity-detail" },
    });
