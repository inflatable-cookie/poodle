...
<style>
  .poodle-token-input {
    --poodle-token-input-radius: var(--poodle-radius-control);
    --poodle-token-input-fill: var(--poodle-recipe-token-input-fill, color-mix(in srgb, var(--poodle-color-background-surface) 96%, transparent));
    --poodle-token-input-fill-focus: var(--poodle-recipe-token-input-fill-focus, var(--poodle-token-input-fill));
    --poodle-token-input-border: var(--poodle-recipe-token-input-border, color-mix(in srgb, var(--poodle-color-border-subtle) 76%, transparent));
    --poodle-token-input-border-focus: var(--poodle-recipe-token-input-border-focus, color-mix(in srgb, var(--poodle-color-accent-base) 58%, var(--poodle-color-border-subtle)));
    --poodle-token-input-shadow: var(--poodle-recipe-token-input-shadow, none);
    --poodle-token-input-shadow-focus: var(--poodle-recipe-token-input-shadow-focus, 0 0 0 0.125rem color-mix(in srgb, var(--poodle-color-accent-base) 18%, transparent));
