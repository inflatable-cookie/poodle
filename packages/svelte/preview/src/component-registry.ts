...
export const primitiveComponents: ComponentEntry[] = [
  ...
  entry("Calendar", "primitive", P, "Date grid for picking a single date or a date range via mode prop.", true),
  ...
  entry("NumberInput", "primitive", P, "Numeric input supporting numeric entry, form-string binding, and optional steppers.", true),
  ...
  entry("CodeInput", "primitive", P, "Code entry with visual digit slots, mask mode, and Field integration.", true),
  ...
  entry("TextInput", "primitive", P, "Single or multi-line text input with type=\"multiline\" and rows support.", true),
...
export const compositeComponents: ComponentEntry[] = [
  ...
  entry("LogList", "composite", C, "Operational log viewer and audit activity list with filtering and pagination.", true),
