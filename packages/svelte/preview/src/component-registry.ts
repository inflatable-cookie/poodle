...
export const allComponents: ComponentEntry[] = [
  ...
  entry("DragNumberField", "input", "Numeric entry supporting pointer drag and direct type-in.", true),
  ...
  entry("AgentSubagent", "display", "An inline group for a provider-owned child agent's work in the transcript.", true),
