<script lang="ts">
  import { FieldSet, Field, TextInput, Select, Eyebrow } from "@pug/svelte-primitives";
</script>
...
<div class="specimen">
  ...
  <div class="specimen__group">
    <Eyebrow>Without legend</Eyebrow>
  ...
  <div class="specimen__group">
    ...
    <div class="form-demo">
      ...
      <FieldSet legend="Preferences">
        ...
        <Field id="fs2-tz" label="Time Zone">
          <Select
            id="fs2-tz"
            options={[
              { value: "utc", label: "UTC" },
