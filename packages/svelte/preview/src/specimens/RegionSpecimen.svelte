<script lang="ts">
  import { Region, Stack } from "@inflatable-cookie/poodle-svelte";
...
<div class="poodle-specimen">
  ...
  <SpecimenGroup label="Layout composition">
    <div class="poodle-specimen__layout">
      <Region label="Nav" color="#5b9bd5" minHeight="100%" />
      <div class="poodle-specimen__layout-main">
