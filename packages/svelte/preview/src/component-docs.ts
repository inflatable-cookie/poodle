...
<RadioGroup {options} value={size} orientation="vertical" selectedColor="#22c55e" onValueChange={(value) => (size = value)} />`,
  ...
  "range-slider": {
    props: [
      ...
      { name: "variant", type: '"block" | "embedded"', default: '"block"', description: "Block is the rounded-square capsule with fixed endpoint anchors; embedded is the dense track-and-thumb alternative for composites." },
...
<Spinner variant="grid" size="lg" tone="accent" ariaLabel="Loading logs" />`,
  ...
  slider: {
    props: [
      ...
      { name: "max", type: "number", default: "100", description: "Maximum allowed value." },
      { name: "step", type: "number", default: "1", description: "Step increment between values." },
      { name: "variant", type: '"block" | "embedded"', default: '"block"', description: "Block is the rounded-square capsule with fixed text; embedded is the dense track-and-thumb alternative for composites." },
      { name: "direction", type: '"ltr" | "rtl"', default: '"ltr"', description: "Inline direction. Horizontal geometry mirrors in rtl; arrow keys keep numeric meaning." },
      { name: "visibleLabel", type: "string | null", default: "null", description: "Visible label for block appearance. Never derived from ariaLabel." },
