...
<Accordion {items} selectionMode="single" collapsible onValueChange={(value) => console.log(value)}>
  ...
  "agent-message": {
    props: [
      { name: "markdown", type: "string", default: '""', description: "Raw markdown for one transcript message." },
      { name: "role", type: "TranscriptRole", default: '"assistant"', description: "Whether the message belongs to the user or assistant." },
      { name: "isStreaming", type: "boolean", default: "false", description: "Shows the non-announced streaming caret while content is arriving." },
      { name: "linkTarget", type: "string | null", default: "null", description: "Target applied to links rendered from markdown." },
      ...
      { name: "onLinkClick", type: "((href: string) => void) | undefined", default: "undefined", description: "Intercepts a rendered markdown link before navigation." },
    ],
    slots: [],
    events: [],
    usage: `<script lang="ts">
...
<AgentMessage
  role="assistant"
  markdown="I updated the **theme tokens**."
  onLinkClick={(href) => console.log(href)}
/>`,
  },

  "agent-plan": {
    props: [
      { name: "plan", type: "string", default: '""', description: "Raw markdown for the proposed plan." },
      { name: "status", type: "AgentPlanStatus", default: '"pending"', description: "Current decision state." },
      { name: "dismissible", type: "boolean", default: "true", description: "Whether the pending plan includes a dismiss action." },
      { name: "dismissLabel", type: "string", default: '"Dismiss plan"', description: "Dismiss action label." },
      { name: "acceptLabel", type: "string", default: '"Accept plan"', description: "Accept action label." },
      { name: "reviseLabel", type: "string", default: '"Revise"', description: "Revision action label." },
      { name: "size", type: "ControlSize | null", default: "null", description: "Explicit semantic size override." },
      { name: "sizeRole", type: "SemanticControlSizeRole", default: '"control"', description: "Semantic size role used when size is inherited." },
      { name: "density", type: "ControlDensity | null", default: "null", description: "Explicit density override." },
      { name: "onAccept", type: "(() => void) | undefined", default: "undefined", description: "Called when the operator accepts the pending plan." },
      { name: "onRevise", type: "(() => void) | undefined", default: "undefined", description: "Called when the operator requests revision." },
      { name: "onDismiss", type: "(() => void) | undefined", default: "undefined", description: "Called when the operator dismisses the plan." },
    ],
    slots: [],
    events: [],
    usage: `<script lang="ts">
...
<AgentPlan
  plan="1. Update tokens\n2. Verify every runtime"
  onAccept={() => acceptPlan()}
...
/>`,
  ...
  "agent-plan-record": {
    props: [
      { name: "plan", type: "string", required: true, description: "Raw markdown for the decided plan." },
      { name: "status", type: "AgentPlanSettledStatus", required: true, description: "Accepted, revised, or dismissed decision state." },
      { name: "decisionLabel", type: "string | undefined", default: "undefined", description: "Badge wording override." },
      { name: "decidedAt", type: "string | undefined", default: "undefined", description: "Host-formatted decision time." },
      { name: "summaryMaxLength", type: "number", default: "160", description: "Character budget for the collapsed summary, including its ellipsis." },
      { name: "expanded", type: "boolean", default: "false", description: "Bindable disclosure state." },
      { name: "expandLabel", type: "string", default: '"Show plan"', description: "Collapsed disclosure label." },
      { name: "collapseLabel", type: "string", default: '"Hide plan"', description: "Expanded disclosure label." },
      { name: "size", type: "ControlSize | null", default: "null", description: "Explicit semantic size override." },
      { name: "sizeRole", type: "SemanticControlSizeRole", default: '"control"', description: "Semantic size role used when size is inherited." },
      { name: "density", type: "ControlDensity | null", default: "null", description: "Explicit density override." },
      { name: "onToggle", type: "((expanded: boolean) => void) | undefined", default: "undefined", description: "Called when the record disclosure changes." },
    ],
    slots: [],
    events: [],
    usage: `<script lang="ts">
...
<AgentPlanRecord
  plan="1. Update tokens\n2. Verify every runtime"
  status="accepted"
  decidedAt="Today at 10:42"
/>`,
  },

  "agent-question": {
    props: [
      { name: "questions", type: "AgentQuestionItem[]", default: "[]", description: "Ordered questions presented to the operator." },
      { name: "activeIndex", type: "number", default: "0", description: "Bindable index of the active question." },
      { name: "selections", type: "string[]", default: "[]", description: "Bindable option values selected for the active question." },
      { name: "override", type: "string", default: '""', description: "Free-text answer owned by the surrounding composer." },
      { name: "dismissible", type: "boolean", default: "false", description: "Whether the active question can be declined." },
      { name: "dismissLabel", type: "string", default: '"Skip this question"', description: "Decline action label." },
      { name: "progressLabel", type: "(current: number, total: number) => string", default: '"{current} of {total}"', description: "Formats batch progress." },
      { name: "showShortcuts", type: "boolean", default: "true", description: "Enables digit shortcuts for the first nine options." },
      { name: "size", type: "ControlSize | null", default: "null", description: "Explicit semantic size override." },
      { name: "sizeRole", type: "SemanticControlSizeRole", default: '"control"', description: "Semantic size role used when size is inherited." },
      { name: "density", type: "ControlDensity | null", default: "null", description: "Explicit density override." },
      { name: "onSelectionChange", type: "((values: string[]) => void) | undefined", default: "undefined", description: "Called when selected option values change." },
      { name: "onSubmit", type: "((answer: AgentQuestionAnswer) => void) | undefined", default: "undefined", description: "Called with the resolved selection, override, or decline answer." },
      { name: "onDismiss", type: "((id: string) => void) | undefined", default: "undefined", description: "Called with the question id before a declined answer is submitted." },
    ],
    slots: [],
    events: [],
    usage: `<script lang="ts">
  import { AgentQuestion, type AgentQuestionItem } from "@inflatable-cookie/poodle-svelte";

  const questions: AgentQuestionItem[] = [{
    id: "runtime",
    prompt: "Which runtime should be verified first?",
    options: [{ value: "web", label: "Web" }, { value: "native", label: "Native" }],
  }];
</script>

<AgentQuestion {questions} onSubmit={(answer) => sendAnswer(answer)} />`,
  },

  "agent-question-record": {
    props: [
      { name: "question", type: "AgentQuestionItem", required: true, description: "Question that was presented." },
      { name: "answer", type: "AgentQuestionAnswer", required: true, description: "Resolved answer left in the transcript." },
      { name: "showOptions", type: "boolean", default: "true", description: "Shows the option list for selected answers." },
      { name: "declinedLabel", type: "string", default: '"Declined"', description: "Summary shown for a declined question." },
      { name: "size", type: "ControlSize | null", default: "null", description: "Explicit semantic size override." },
      { name: "sizeRole", type: "SemanticControlSizeRole", default: '"control"', description: "Semantic size role used when size is inherited." },
      { name: "density", type: "ControlDensity | null", default: "null", description: "Explicit density override." },
    ],
    ...
    events: [],
    usage: `<script lang="ts">
  import { AgentQuestionRecord } from "@inflatable-cookie/poodle-svelte";
  ...
  const answer = { questionId: "runtime", outcome: "selected" as const, values: ["web"], text: "" };
</script>
...
<AgentSubagent {item} detailLines={["Indexed 3 registries", "Comparing render outputs"]} onOpenChild={() => console.log("open child work")} />`,
  ...
  "agent-transcript": {
    props: [
      ...
      { name: "virtualized", type: "boolean", default: "true", description: "Windows transcript blocks using measured heights." },
      { name: "estimatedBlockHeight", type: "number", default: "120", description: "Fallback block height before measurement." },
      { name: "overscan", type: "number", default: "3", description: "Extra blocks rendered around the visible window." },
      { name: "autoScroll", type: "boolean", default: "true", description: "Follows appended content while pinned to the bottom." },
      { name: "pinThreshold", type: "number", default: "32", description: "Pixel distance from the bottom that counts as pinned." },
      { name: "jumpLabel", type: "string", default: '"Jump to latest"', description: "Label for the return-to-bottom control." },
      { name: "ariaLabel", type: "string", default: '"Conversation"', description: "Accessible label for the transcript region." },
      { name: "emptyLabel", type: "string", default: '"No messages yet"', description: "Empty transcript message." },
      { name: "expandedToolRuns", type: "string[]", default: "[]", description: "Bindable ids of expanded tool-call runs." },
      { name: "expandedToolCalls", type: "string[]", default: "[]", description: "Bindable ids of expanded individual tool calls." },
      { name: "expandedChangedFiles", type: "string[]", default: "[]", description: "Bindable ids of expanded changed-file cards." },
      { name: "size", type: "ControlSize | null", default: "null", description: "Explicit semantic size override." },
      { name: "sizeRole", type: "SemanticControlSizeRole", default: '"control"', description: "Semantic size role used when size is inherited." },
      { name: "density", type: "ControlDensity | null", default: "null", description: "Explicit density override." },
      { name: "onToolRunToggle", type: "((id: string) => void) | undefined", default: "undefined", description: "Called when a grouped tool run opens or closes." },
      { name: "onToolCallToggle", type: "((id: string) => void) | undefined", default: "undefined", description: "Called when an individual tool output opens or closes." },
      { name: "onChangedFilesToggle", type: "((id: string) => void) | undefined", default: "undefined", description: "Called when a changed-file card opens or closes." },
      { name: "onOpenDiff", type: "((id: string) => void) | undefined", default: "undefined", description: "Requests the host diff view for a changed-file card." },
      { name: "onFileSelect", type: "((path: string) => void) | undefined", default: "undefined", description: "Requests a host action for one changed file." },
      { name: "onScrollStateChange", type: "((pinned: boolean) => void) | undefined", default: "undefined", description: "Reports whether the viewport remains pinned to the latest content." },
    ],
    slots: [],
    events: [],
    usage: `<script lang="ts">
  ...
  const items: TranscriptItem[] = [
    ...
    { kind: "tool-call", id: "t1", label: "Ran command", status: "success", detail: "effigy docs:check" },
  ];
</script>

<AgentTranscript {items} ariaLabel="Release audit conversation" />`,
  },

  "changed-files": {
    props: [
      { name: "id", type: "string", required: true, description: "Stable card id used for disclosure and host callbacks." },
      { name: "files", type: "ChangedFile[]", default: "[]", description: "Changed paths with addition, deletion, and status metadata." },
      { name: "expanded", type: "boolean", default: "false", description: "Bindable card disclosure state." },
      { name: "expandedPaths", type: "string[]", default: "[]", description: "Bindable expanded directory paths in the file tree." },
      { name: "chipLimit", type: "number", default: "3", description: "Maximum file chips shown while collapsed." },
      { name: "showOpenDiff", type: "boolean", default: "true", description: "Shows the host-owned diff action." },
      { name: "openDiffLabel", type: "string", default: '"Open diff"', description: "Diff action label." },
      { name: "showFilesLabel", type: "string", default: '"Show files"', description: "Collapsed disclosure label." },
      { name: "hideFilesLabel", type: "string", default: '"Hide files"', description: "Expanded disclosure label." },
      { name: "countLabel", type: "(count: number) => string", default: '"{count} changed files"', description: "Formats the file-count label." },
      { name: "size", type: "ControlSize | null", default: "null", description: "Explicit semantic size override." },
      { name: "sizeRole", type: "SemanticControlSizeRole", default: '"control"', description: "Semantic size role used when size is inherited." },
      { name: "density", type: "ControlDensity | null", default: "null", description: "Explicit density override." },
      { name: "onToggle", type: "((id: string) => void) | undefined", default: "undefined", description: "Called when the card disclosure changes." },
      { name: "onOpenDiff", type: "((id: string) => void) | undefined", default: "undefined", description: "Requests the host diff view." },
      { name: "onFileSelect", type: "((path: string) => void) | undefined", default: "undefined", description: "Requests a host action for one file." },
      { name: "onExpandedPathsChange", type: "((paths: string[]) => void) | undefined", default: "undefined", description: "Called when expanded directory paths change." },
    ],
    slots: [],
    events: [],
    usage: `<script lang="ts">
  import { ChangedFiles } from "@inflatable-cookie/poodle-svelte";

  const files = [
    { path: "src/app.ts", additions: 12, deletions: 3, status: "modified" as const },
  ];
</script>

<ChangedFiles id="release-files" {files} onOpenDiff={(id) => openDiff(id)} />`,
  },

  "tool-call": {
    props: [
      { name: "id", type: "string", required: true, description: "Stable row id used by disclosure state and callbacks." },
      { name: "label", type: "string", required: true, description: "Human-readable work label." },
      { name: "detail", type: "string | null", default: "null", description: "Single-line command or argument detail." },
      { name: "status", type: "ToolCallStatus", default: '"success"', description: "Running, success, or error state." },
      { name: "icon", type: "string | null", default: "null", description: "Icon-name override; otherwise inferred from the label." },
      { name: "output", type: "string | null", default: "null", description: "Full output revealed by the row disclosure." },
      { name: "outputLanguage", type: "string | null", default: "null", description: "Language hint for output syntax highlighting." },
      { name: "expanded", type: "boolean", default: "false", description: "Bindable output disclosure state." },
      { name: "size", type: "ControlSize | null", default: "null", description: "Explicit semantic size override." },
      { name: "sizeRole", type: "SemanticControlSizeRole", default: '"control"', description: "Semantic size role used when size is inherited." },
      { name: "density", type: "ControlDensity | null", default: "null", description: "Explicit density override." },
      { name: "onToggle", type: "((id: string) => void) | undefined", default: "undefined", description: "Called when output opens or closes." },
    ],
    slots: [],
    events: [],
    usage: `<script lang="ts">
  import { ToolCall } from "@inflatable-cookie/poodle-svelte";
</script>

<ToolCall
  id="check"
  label="Ran command"
  detail="effigy docs:check"
...
/>`,
  ...
  "tool-call-group": {
    props: [
      { name: "id", type: "string", required: true, description: "Stable id for the contiguous tool run." },
      { name: "calls", type: "TranscriptToolCall[]", default: "[]", description: "Tool calls in chronological order." },
      { name: "expanded", type: "boolean", default: "false", description: "Bindable grouped-run disclosure state." },
      { name: "expandedCalls", type: "string[]", default: "[]", description: "Bindable ids of calls whose output is expanded." },
      { name: "moreLabel", type: "(count: number) => string", default: '"+{count} previous tool calls"', description: "Formats the collapsed hidden-call count." },
      { name: "fewerLabel", type: "string", default: '"Show fewer tool calls"', description: "Expanded disclosure label." },
      { name: "size", type: "ControlSize | null", default: "null", description: "Explicit semantic size override." },
      { name: "sizeRole", type: "SemanticControlSizeRole", default: '"control"', description: "Semantic size role used when size is inherited." },
      { name: "density", type: "ControlDensity | null", default: "null", description: "Explicit density override." },
      { name: "onToggle", type: "((id: string) => void) | undefined", default: "undefined", description: "Called when the grouped run opens or closes." },
      { name: "onCallToggle", type: "((id: string) => void) | undefined", default: "undefined", description: "Called when an individual call output opens or closes." },
    ],
    slots: [],
    events: [],
    usage: `<script lang="ts">
  import { ToolCallGroup, type TranscriptToolCall } from "@inflatable-cookie/poodle-svelte";

  const calls: TranscriptToolCall[] = [
    { kind: "tool-call", id: "scan", label: "Searched", status: "success", detail: "package exports" },
    { kind: "tool-call", id: "check", label: "Ran command", status: "success", detail: "effigy docs:check" },
  ];
</script>

<ToolCallGroup id="release-audit" {calls} />`,
  },
...
<DetailShell title="User Profile" state="ready">
  ...
  dialog: {
    props: [
      ...
      { name: "sizeRole", type: '"chrome" | "control" | "prominent"', default: '"control"', description: "Semantic size offset relative to the inherited presentation scale." },
      { name: "density", type: "ControlDensity | null", default: "null", description: "Explicit density override. Supports compact, default, and comfortable." },
      { name: "initialFocus", type: '"auto" | "none" | string', default: '"auto"', description: "Where focus lands when the dialog opens. \"auto\" focuses the first focusable element in the body (the surface itself when the body has none); \"none\" focuses nothing; a string is a CSS selector resolved within the surface, falling back to \"auto\" when unmatched." },
...
<FormActions align="end" showTopBorder {dangerItems}>
  ...
  "form-dialog": {
    props: [
      ...
      { name: "initialFocus", type: '"auto" | "none" | string', default: '"auto"', description: "Where focus lands when the dialog opens. The default focuses the first focusable element in the form body — the first field. A consumer-supplied value wins." },
      { name: "ariaLabel", type: "string | null", default: "null", description: "Accessible label for the dialog." },
...
<IconProvider {icons}>
  ...
  "icon-provider": {
    props: [
      { name: "icons", type: "IconSet", required: true, description: "An application icon set mapping names to SVG node arrays. String lookups resolve from this set first, then Poodle's scoped default Lucide set. Missing names report an error and render a visible error glyph." },
    ],
    slots: [
...
<NavCard title="Dashboard" description="View your analytics" href="/dashboard" badge="New">
  ...
  "number-input": {
    props: [
      ...
      { name: "value", type: "number | null | undefined", default: "undefined", description: "Controlled committed value. null is committed empty; undefined means uncontrolled." },
      { name: "defaultValue", type: "number | null", default: "null", description: "Initial committed value for uncontrolled mode." },
      { name: "draftValue", type: "string | null | undefined", default: "undefined", description: "Optional controlled raw draft. undefined lets the adapter own the draft; null means no draft override." },
      ...
      { name: "min", type: "number | null", default: "null", description: "Optional inclusive lower bound." },
      { name: "max", type: "number | null", default: "null", description: "Optional inclusive upper bound." },
      { name: "step", type: "number | null", default: "null", description: "Optional positive finite step. Omitted means 1." },
      { name: "precision", type: "number | null", default: "null", description: "Optional non-negative maximum fractional digits and fixed committed display scale." },
      { name: "prefix", type: "string | null", default: "null", description: "Optional prefix chip rendered before the control." },
      { name: "suffix", type: "string | null", default: "null", description: "Optional suffix chip rendered after the control." },
      { name: "validationState", type: "ValidationState", default: '"none"', description: "Validation state of the input." },
      { name: "validate", type: "InputValidator | undefined", default: "undefined", description: "Optional async validator for committed canonical decimal strings." },
      ...
      { name: "onValueChange", type: "((value: number | null) => void) | undefined", default: "undefined", description: "Called when a distinct valid committed value forms, or the field is cleared." },
      { name: "onDraftValueChange", type: "((draft: string | null) => void) | undefined", default: "undefined", description: "Called on every raw draft edit; null asks a controlled host to discard its draft override." },
      ...
      { name: "onCommit", type: "((value: number | null) => void) | undefined", default: "undefined", description: "Called on valid Enter/blur or a successful step action." },
...
<Progress indeterminate ariaLabel="Loading..." />`,
  ...
  radio: {
    props: [
      { name: "id", type: "string | undefined", default: "undefined", description: "Native input id." },
      { name: "name", type: "string | undefined", default: "undefined", description: "Native form field name used for group exclusivity." },
      { name: "value", type: "string | undefined", default: "undefined", description: "Native form value." },
      { name: "checked", type: "boolean | undefined", default: "undefined", description: "Bindable controlled checked state." },
      { name: "defaultChecked", type: "boolean", default: "false", description: "Initial checked state for uncontrolled mode." },
      { name: "disabled", type: "boolean", default: "false", description: "Disables activation and form submission." },
      { name: "readOnly", type: "boolean", default: "false", description: "Keeps the control focusable while reverting changes." },
      { name: "label", type: "string | null", default: "null", description: "Visible label for the option." },
      { name: "ariaLabel", type: "string | null", default: "null", description: "Accessible label used only when no visible label is present." },
      { name: "describedBy", type: "string | null", default: "null", description: "Id of descriptive content." },
      { name: "selectedColor", type: "string | null", default: "null", description: "Selected indicator color override." },
      { name: "size", type: "ControlSize | null", default: "null", description: "Explicit semantic size override." },
      { name: "sizeRole", type: "SemanticControlSizeRole", default: '"control"', description: "Semantic size role used when size is inherited." },
      { name: "density", type: "ControlDensity | null", default: "null", description: "Explicit density override." },
      { name: "onCheckedChange", type: "((checked: boolean) => void) | undefined", default: "undefined", description: "Called when the checked state changes." },
    ...
    events: [],
    usage: `<script lang="ts">
  import { Radio } from "@inflatable-cookie/poodle-svelte";
...
<Radio
  ...
  onCheckedChange={(checked) => { if (checked) selected = "daily"; }}
/>`,
  },
...
<RadioGroup {options} value={size} orientation="vertical" selectedColor="#22c55e" onValueChange={(value) => (size = value)} />`,
  ...
  "range-slider": {
    props: [
      ...
      { name: "variant", type: '"standard" | "embedded"', default: '"standard"', description: "Uses native range inputs or the dense control-machine pointer surface." },
      { name: "appearance", type: '"track" | "block"', default: '"track"', description: "Visual treatment. Orthogonal to variant. Block is horizontal only." },
      { name: "direction", type: '"ltr" | "rtl"', default: '"ltr"', description: "Inline direction. Horizontal geometry mirrors in rtl; arrow keys keep numeric meaning." },
      { name: "visibleLabel", type: "string | null", default: "null", description: "Visible label for block appearance. Never derived from ariaLabel." },
      { name: "formatVisibleValue", type: "((value: number, thumb: \"lower\" | \"upper\") => string) | undefined", default: "undefined", description: "Web-only per-thumb formatter for block visible values. Native specs carry resolved strings." },
      { name: "formatVisibleRange", type: "((lower: number, upper: number) => string) | undefined", default: "undefined", description: "Web-only formatter for the selected-window range text. Native specs carry the resolved string." },
      { name: "polarity", type: '"unipolar" | "bipolar"', default: '"unipolar"', description: "Selects a zero-origin or center-referenced embedded presentation." },
      { name: "centerValue", type: "number | null", default: "null", description: "Optional bipolar center override; zero or the range midpoint is used when omitted." },
      { name: "law", type: "AudioValueLaw", default: 'linear', description: "Value law used by embedded pointer mapping." },
...
<ScrollShell direction="vertical" padding="md" style="max-height: 300px;">
  ...
  stepper: {
    props: [
      ...
      { name: "orientation", type: '"horizontal" | "vertical"', default: '"horizontal"', description: "Axis the steps flow along. Vertical stacks the steps as rows in the same shared track." },
      { name: "collapsible", type: "boolean", default: "false", description: "Renders the summary row as a disclosure trigger. Vertical only — a horizontal stepper is already one line." },
      { name: "collapsed", type: "boolean | undefined", default: "undefined", description: "Bindable collapse state. Leave undefined for uncontrolled mode." },
      { name: "defaultCollapsed", type: "boolean", default: "false", description: "Initial collapse state for uncontrolled mode." },
      ...
      { name: "onCollapsedChange", type: "((collapsed: boolean) => void) | undefined", default: "undefined", description: "Called when the summary row toggles; carries the new collapse state." },
    ],
    slots: [],
    events: [],
    usage: `<Stepper
...
<SidebarNav {groups} value={active} ariaLabel="Main navigation" onValueChange={(value) => (active = value)} />`,
  ...
  "settings-shell": {
    ...
    slots: [{ name: "page", description: "The current page body; always a snippet." }],
    events: [],
    usage: `<script lang="ts">
...
<Spinner variant="grid" size="lg" tone="accent" ariaLabel="Loading logs" />`,
  ...
  slider: {
    props: [
      ...
      { name: "max", type: "number", default: "100", description: "Maximum allowed value." },
      { name: "step", type: "number", default: "1", description: "Step increment between values." },
      { name: "variant", type: '"standard" | "embedded"', default: '"standard"', description: "Uses the native input or dense control-machine pointer surface." },
      { name: "appearance", type: '"track" | "block"', default: '"track"', description: "Visual treatment. Orthogonal to variant. Block is horizontal only." },
      { name: "direction", type: '"ltr" | "rtl"', default: '"ltr"', description: "Inline direction. Horizontal geometry mirrors in rtl; arrow keys keep numeric meaning." },
      { name: "visibleLabel", type: "string | null", default: "null", description: "Visible label for block appearance. Never derived from ariaLabel." },
      { name: "formatVisibleValue", type: "((value: number) => string) | undefined", default: "undefined", description: "Web-only formatter for block visible value. Native specs carry the resolved string." },
      { name: "polarity", type: '"unipolar" | "bipolar"', default: '"unipolar"', description: "Selects a zero-origin or center-referenced embedded presentation." },
      { name: "centerValue", type: "number | null", default: "null", description: "Optional bipolar center override; zero or the range midpoint is used when omitted." },
      { name: "law", type: "AudioValueLaw", default: 'linear', description: "Value law used by embedded pointer mapping." },
      { name: "orientation", type: "Orientation", default: '"horizontal"', description: "Layout orientation of the slider." },
...
<button onclick={() => emailInput?.focus()}>Focus email</button>`,
  ...
  "time-ago": {
    props: [
      ...
      { name: "futureFormat", type: '"in" | "from-now"', default: '"in"', description: "Render future times as in 5m or 5m from now to fit surrounding copy." },
      { name: "futurePrefix", type: "string | null", default: "null", description: "Optional phrase before future output, such as ends in 5m." },
      { name: "pastPrefix", type: "string | null", default: "null", description: "Optional phrase before past output, such as ended 5m ago." },
