...
<style>
  ...
  /* Density variants — padding and gap */
  .bulk-action-bar[data-density="compact"] { padding: 0.5rem 0.75rem; gap: 0.375rem; }
  .bulk-action-bar[data-density="comfortable"] { padding: 1rem 1.25rem; gap: 1rem; }
</style>
