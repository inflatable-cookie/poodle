...
use poodle_gpui_components::{Eyebrow, MediaUploadStatusPanel};
        ...
        .child(
            div()
                ...
                .child(Eyebrow::from_spec(
                    EyebrowSpec::new().with_content("Upload status panel"),
                    theme,
                ))
                .child(
                    div()
                        ...
                        .flex_col()
                        .gap(px(12.0))
                        .child(MediaUploadStatusPanel::from_spec(
                            MediaUploadStatusPanelSpec::new().with_step(MediaUploadStep::Checking),
                            theme,
                        ))
                        .child(MediaUploadStatusPanel::from_spec(
                        ...
                        .child(MediaUploadStatusPanel::from_spec(
                            MediaUploadStatusPanelSpec::new().with_step(MediaUploadStep::Complete),
                            theme,
                        ))
                        .child(MediaUploadStatusPanel::from_spec(
                            MediaUploadStatusPanelSpec::new()
                                ...
                                .with_upload_error(
                                    "Upload failed because the file could not be finalised.",
                                ),
                            theme,
                        )),
                ),
