    ...
    div()
        ...
        .child(
            div()
                ...
                .child(Eyebrow::from_spec(
                    EyebrowSpec::new().with_content("Panel tone (default)"),
                    theme,
                ))
                .child(
                    Surface::from_spec(
        ...
        .child(
            div()
                ...
                .gap(px(8.0))
                .child(Eyebrow::from_spec(
                    EyebrowSpec::new().with_content("Canvas tone"),
                    theme,
                ))
                .child(
                    Surface::from_spec(
        ...
        .child(
            div()
                ...
                .gap(px(8.0))
                .child(Eyebrow::from_spec(
                    EyebrowSpec::new().with_content("Elevated tone"),
                    theme,
                ))
                .child(
                    Surface::from_spec(
                    ...
                    .with_content(
                        div()
                            ...
                            .text_color(color_to_hsla(text_secondary))
                            .child(
                                "Elevated surface with shadow for overlays and cards.".to_string(),
                            ),
                    ),
                ),
        )
        ...
        .child(
            div()
                ...
                .gap(px(8.0))
                .child(Eyebrow::from_spec(
                    EyebrowSpec::new().with_content("No border"),
                    theme,
                ))
                .child(
                    Surface::from_spec(
                    ...
                    .with_content(
                        div()
                            ...
                            .text_color(color_to_hsla(text_secondary))
                            .child(
                                "Surface with no border \u{2014} just padding and background."
                                    .to_string(),
                            ),
                    ),
                ),
