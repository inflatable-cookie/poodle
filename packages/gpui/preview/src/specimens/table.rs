    ...
    div()
        ...
        .child(
            div()
                ...
                .child(Eyebrow::from_spec(
                    EyebrowSpec::new().with_content("Standard table"),
                    theme,
                ))
        ...
        .child(
            div()
                ...
                .gap(px(8.0))
                .child(Eyebrow::from_spec(
                    EyebrowSpec::new().with_content("With caption"),
                    theme,
                ))
                .child(Table::from_spec(
                    TableSpec::new()
        ...
        .child(
            div()
                ...
                .gap(px(8.0))
                .child(Eyebrow::from_spec(
                    EyebrowSpec::new().with_content("Minimal key-value"),
                    theme,
                ))
                .child(Table::from_spec(
                    TableSpec::new()
        ...
        .child(
            div()
                ...
                .gap(px(8.0))
                .child(Eyebrow::from_spec(
                    EyebrowSpec::new().with_content("Empty table"),
                    theme,
                ))
                .child(Table::from_spec(
                    TableSpec::new()
