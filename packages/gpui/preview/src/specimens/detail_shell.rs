...
use pug_gpui_components::{DetailShell, DetailRow, DetailSection, Button, Eyebrow};
use pug_primitives::{DetailRowSpec, ButtonSpec, ButtonVariant, ControlSize, EyebrowSpec};
