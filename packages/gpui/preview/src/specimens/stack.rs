...
use pug_gpui_primitives::{Alignment, PaddingScale, StackSpec, SurfaceBorder, SurfaceSpec, SurfaceTone};
use pug_gpui_components::{PugStack, PugSurface};
    ...
    div().flex().flex_col().gap(px(24.0))
        ...
        .child(
            div().flex().flex_col().gap(px(8.0))
                ...
                .child(
                    PugStack::new(StackSpec::new().with_gap(PaddingScale::Md), theme)
