...
use poodle_gpui_components::{Eyebrow, Separator};
use poodle_specs::{EyebrowSpec, SeparatorOrientation, SeparatorSpec};
    ...
    div()
        ...
        .child(
            div()
                ...
                .child(Eyebrow::from_spec(
                    EyebrowSpec::new().with_content("Horizontal (default)"),
                    theme,
                ))
                .child(
                    div()
        ...
        .child(
            div()
                ...
                .gap(px(8.0))
                .child(Eyebrow::from_spec(
                    EyebrowSpec::new().with_content("Vertical"),
                    theme,
                ))
                .child(
                    div()
        ...
        .child(
            div()
                ...
                .gap(px(8.0))
                .child(Eyebrow::from_spec(
                    EyebrowSpec::new().with_content("Decorative"),
                    theme,
                ))
                .child(Separator::from_spec(
