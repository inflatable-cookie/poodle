// Generated by poodle-codegen 0.2.3. Do not edit manually.
...
pub const CANONICAL_COMPONENTS: &[CanonicalComponent] = &[
    ...
    CanonicalComponent {
		slug: "motion-policy-provider",
		display_name: "MotionPolicyProvider",
		description: "Scoped provider for the effective full, reduced, or frozen host motion policy.",
		section: CatalogueSectionId::Foundations,
		family: CatalogueFamilyId::ContentIdentity,
		kind: CatalogueKindId::Display,
		collections: &[],
