...
pub static PRIMITIVES: &[ComponentEntry] = &[
    ...
    ComponentEntry { slug: "detail-item", display_name: "DetailItem", description: "Label-value metadata pair." },
    ...
    ComponentEntry { slug: "field-set", display_name: "FieldSet", description: "Groups related form controls with optional legend and multi-column layout." },
    ...
    ComponentEntry { slug: "number-input", display_name: "NumberInput", description: "Numeric input with controls." },
...
pub static COMPOSITES: &[ComponentEntry] = &[
    ...
    ComponentEntry { slug: "list-container", display_name: "ListContainer", description: "Paginated list view with header and state handling." },
    ...
    ComponentEntry { slug: "media-browse-panel", display_name: "MediaBrowsePanel", description: "Grid of selectable media items." },
    ...
    ComponentEntry { slug: "media-upload-status-panel", display_name: "MediaUploadStatusPanel", description: "Upload workflow status panel." },
