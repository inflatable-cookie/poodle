//! PugMediaPreview — real GPUI component backed by MediaPreviewSpec.
...
impl PugMediaPreview {
    pub fn new(spec: MediaPreviewSpec, theme: &GpuiThemeProvider) -> Self {
        Self {
            spec,
            theme: theme.clone(),
            media_content: None,
...
impl IntoElement for PugMediaPreview {
