//! PugListCard — real GPUI component backed by ListCardSpec.

use gpui::prelude::FluentBuilder;
use gpui::*;
use pug_gpui::GpuiThemeProvider;
use pug_gpui_primitives::{LeadingFill, ListCardSpec};

use crate::theme_ext::{color_mix, resolve_color, resolve_opacity, resolve_px, resolve_radius};

/// A real GPUI list-card component backed by `ListCardSpec`.
pub struct PugListCard {
    spec: ListCardSpec,
...
impl PugListCard {
    pub fn new(spec: ListCardSpec, theme: &GpuiThemeProvider) -> Self {
        Self {
            spec,
            theme: theme.clone(),
            leading: None,
...
impl IntoElement for PugListCard {
    ...
    fn into_element(self) -> Self::Element {
        ...
        let leading_size = px(spec.leading_size_px());
        let leading_radius = px(spec.leading_radius_px());
