//! PugToastStack — real GPUI component backed by ToastStackSpec.
...
use pug_gpui_composites::{ToastPosition, ToastStackSpec};
...
impl PugToastStack {
    pub fn new(spec: ToastStackSpec, theme: &GpuiThemeProvider) -> Self {
        Self {
            spec,
            theme: theme.clone(),
            on_dismiss: None,
...
impl IntoElement for PugToastStack {
