//! PugMediaThumbnail — real GPUI component backed by MediaThumbnailSpec.

use gpui::prelude::FluentBuilder;
use gpui::*;
use pug_gpui::GpuiThemeProvider;
use pug_gpui_composites::{MediaThumbnailSpec, AspectRatio, MediaKind, MediaState};
...
pub struct PugMediaThumbnail {
    spec: MediaThumbnailSpec,
    theme: GpuiThemeProvider,
    image_content: Option<AnyElement>,
}

impl PugMediaThumbnail {
    pub fn new(spec: MediaThumbnailSpec, theme: &GpuiThemeProvider) -> Self {
        Self {
            spec,
            theme: theme.clone(),
            image_content: None,
...
impl IntoElement for PugMediaThumbnail {
