...
use pug_gpui_primitives::AlertDialogSpec;
use crate::theme_ext::{resolve_color, resolve_px, resolve_radius};

pub struct PugAlertDialog {
...
impl PugAlertDialog {
    pub fn new(spec: AlertDialogSpec, theme: &GpuiThemeProvider) -> Self {
        Self {
...
impl IntoElement for PugAlertDialog {
