...
use pug_gpui_primitives::{OrderBySpec, SortDirection};
use crate::theme_ext::{resolve_color, resolve_opacity, resolve_px, resolve_radius};

pub struct PugOrderBy {
    spec: OrderBySpec,
    label_color: Hsla,
    field_fill: Hsla,
    field_border: Hsla,
...
impl PugOrderBy {
    pub fn new(spec: OrderBySpec, theme: &GpuiThemeProvider) -> Self {
...
impl IntoElement for PugOrderBy {
