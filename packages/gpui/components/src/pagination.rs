...
use pug_gpui_primitives::{PageItem, PaginationSpec};

use crate::theme_ext::{color_mix, resolve_color, resolve_opacity, resolve_px, resolve_radius};

pub struct PugPagination {
    spec: PaginationSpec,
    // Pre-resolved values
    button_fill: Hsla,
    button_border: Hsla,
...
impl PugPagination {
    pub fn new(spec: PaginationSpec, theme: &GpuiThemeProvider) -> Self {
...
impl IntoElement for PugPagination {
    ...
    fn into_element(self) -> Self::Element {
        ...
        let page_gap = self.spec.page_gap_px();
        let nav_gap = self.spec.nav_gap_px();
