//! PugRangeCalendar — real GPUI component backed by RangeCalendarSpec.
...
///
/// Similar to `PugCalendar` but highlights a date range instead of a single day.
pub struct PugRangeCalendar {
    spec: RangeCalendarSpec,
    theme: GpuiThemeProvider,
    id_suffix: Option<String>,
}

impl PugRangeCalendar {
    pub fn new(spec: RangeCalendarSpec, theme: &GpuiThemeProvider) -> Self {
        Self {
            spec,
            theme: theme.clone(),
            id_suffix: None,
...
impl IntoElement for PugRangeCalendar {
    ...
    fn into_element(self) -> Self::Element {
        ...
        let week_start_offset: u32 = match spec.week_starts_on {
            pug_gpui_primitives::CalendarWeekStart::Monday => 1,
            _ => 0,
        };
