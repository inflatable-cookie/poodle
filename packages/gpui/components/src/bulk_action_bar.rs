//! PugBulkActionBar — real GPUI component backed by BulkActionBarSpec.

use gpui::prelude::FluentBuilder;
use gpui::*;
use pug_gpui::GpuiThemeProvider;
use pug_gpui_primitives::{BulkActionBarSpec, BulkActionTone};

use crate::theme_ext::{color_mix, resolve_color, resolve_px, resolve_radius};

/// A real GPUI bulk-action bar component backed by `BulkActionBarSpec`.
pub struct PugBulkActionBar {
    spec: BulkActionBarSpec,
    theme: GpuiThemeProvider,
    on_action: Option<Box<dyn Fn(&str, &mut Window, &mut App) + 'static>>,
}

impl PugBulkActionBar {
    pub fn new(spec: BulkActionBarSpec, theme: &GpuiThemeProvider) -> Self {
        Self {
            spec,
            theme: theme.clone(),
            on_action: None,
...
impl IntoElement for PugBulkActionBar {
