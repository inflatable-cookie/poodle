//! PugSplitView — real GPUI component backed by SplitViewSpec.
...
impl PugSplitView {
    pub fn new(spec: SplitViewSpec, theme: &GpuiThemeProvider) -> Self {
        Self {
            spec,
            theme: theme.clone(),
            primary: None,
...
impl IntoElement for PugSplitView {
