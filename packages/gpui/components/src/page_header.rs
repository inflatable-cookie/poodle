//! PugPageHeader — real GPUI component backed by PageHeaderSpec.

use gpui::prelude::FluentBuilder;
use gpui::*;
use pug_gpui::GpuiThemeProvider;
use pug_gpui_composites::{PageHeaderAlign, PageHeaderSpec};
...
impl PugPageHeader {
    pub fn new(spec: PageHeaderSpec, theme: &GpuiThemeProvider) -> Self {
        Self {
            spec,
            theme: theme.clone(),
...
impl IntoElement for PugPageHeader {
