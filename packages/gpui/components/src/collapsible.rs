//! PugCollapsible — real GPUI component backed by CollapsibleSpec.
...
impl PugCollapsible {
    pub fn new(spec: CollapsibleSpec, theme: &GpuiThemeProvider) -> Self {
        Self {
            spec,
            theme: theme.clone(),
            id_suffix: None,
...
impl IntoElement for PugCollapsible {
