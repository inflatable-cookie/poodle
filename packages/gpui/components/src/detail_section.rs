//! PugDetailSection — real GPUI component backed by DetailSectionSpec.

use gpui::prelude::FluentBuilder;
use gpui::*;
use pug_gpui::GpuiThemeProvider;
use pug_gpui_composites::DetailSectionSpec;
...
impl PugDetailSection {
    pub fn new(spec: DetailSectionSpec, theme: &GpuiThemeProvider) -> Self {
        Self {
            spec,
            theme: theme.clone(),
            actions_slot: None,
...
impl IntoElement for PugDetailSection {
