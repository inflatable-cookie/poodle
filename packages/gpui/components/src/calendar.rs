//! PugCalendar — real GPUI component backed by CalendarSpec.
...
impl PugCalendar {
    pub fn new(spec: CalendarSpec, theme: &GpuiThemeProvider) -> Self {
        Self {
            spec,
            theme: theme.clone(),
            id_suffix: None,
...
impl IntoElement for PugCalendar {
