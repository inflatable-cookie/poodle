...
use pug_gpui_primitives::DetailRowSpec;

use crate::theme_ext::{resolve_color, resolve_px, resolve_radius};

pub struct PugDetailRow {
    spec: DetailRowSpec,
    label_color: Hsla,
    value_color: Hsla,
...
impl PugDetailRow {
    pub fn new(spec: DetailRowSpec, theme: &GpuiThemeProvider) -> Self {
...
impl IntoElement for PugDetailRow {
