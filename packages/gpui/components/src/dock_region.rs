//! PugDockRegion — real GPUI component backed by DockRegionSpec.
...
impl PugDockRegion {
    pub fn new(spec: DockRegionSpec, theme: &GpuiThemeProvider) -> Self {
        Self {
            spec,
            theme: theme.clone(),
            id_prefix: "pug-dock".to_string(),
            content: None,
            on_tab_change: None,
...
impl IntoElement for PugDockRegion {
