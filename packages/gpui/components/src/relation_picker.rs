//! PugRelationPicker — real GPUI component backed by RelationPickerSpec.
...
pub struct PugRelationPicker {
    spec: RelationPickerSpec,
    theme: GpuiThemeProvider,
    on_select: Option<Box<dyn Fn(&str, &ClickEvent, &mut Window, &mut App) + 'static>>,
}

impl PugRelationPicker {
    pub fn new(spec: RelationPickerSpec, theme: &GpuiThemeProvider) -> Self {
        Self {
            spec,
            theme: theme.clone(),
            on_select: None,
...
impl IntoElement for PugRelationPicker {
