/**
 * Color conversion machinery (ColorPicker).
 * Contract: docs/contracts/components/color-picker.md, "Behavior Machine".
 *
 * Pure conversions promoted wholesale from the Svelte color-utils module
 * (which now re-exports from here). Internal model uses HSV for the
 * gradient pad; HSL/RGB/hex for display and I/O.
 */
