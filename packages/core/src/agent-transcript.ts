 ...
 * contiguous tool-run grouping, and variable-height scroll windowing. Rendering,
 ...
 *
 * The Rust mirror is `poodle-specs::agent_transcript`. Both are driven by the
 * fixtures in `test/fixtures/agent-transcript.json`, so grouping cannot drift
 * between the web targets and the natives.
 */
