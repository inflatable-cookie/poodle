...
mod tests {
    ...
    #[test] fn media_thumbnail() { assert_eq!(a().render(&MediaThumbnailSpec::new(poodle_specs::MediaKind::Image), &s(), &t()).widget_kind, WidgetKind::Image); }
    #[test] fn media_preview() { assert_eq!(a().render(&MediaPreviewSpec::new(poodle_specs::MediaKind::Image, "Preview"), &s(), &t()).spec_type, "MediaPreviewSpec"); }
    ...
    #[test] fn editable_list() { assert_eq!(a().render(&EditableListSpec::new(), &s(), &t()).widget_kind, WidgetKind::List); }
