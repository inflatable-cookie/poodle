...
pub static COMPOSITES: &[ComponentEntry] = &[
    ...
    ComponentEntry { slug: "debug-dialog", display_name: "DebugDialog", description: "Developer JSON debug disclosure.", tier: Tier::Composite, has_specimen: true },
    ...
    ComponentEntry { slug: "error-boundary", display_name: "ErrorBoundary", description: "Error fallback with retry.", tier: Tier::Composite, has_specimen: true },
