...
pub static PRIMITIVES: &[ComponentEntry] = &[
    ...
    ComponentEntry { slug: "filter-builder", display_name: "FilterBuilder", description: "Popover filter-clause builder with editable pills.", tier: Tier::Primitive, has_specimen: true },
