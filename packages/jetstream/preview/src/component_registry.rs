...
pub static PRIMITIVES: &[ComponentEntry] = &[
    ...
    ComponentEntry { slug: "detail-row", display_name: "DetailRow", description: "Label-value metadata pair.", tier: Tier::Primitive, has_specimen: true },
    ...
    ComponentEntry { slug: "text-area", display_name: "TextArea", description: "Multi-line text input.", tier: Tier::Primitive, has_specimen: true },
    ComponentEntry { slug: "text-input", display_name: "TextInput", description: "Single-line text input.", tier: Tier::Primitive, has_specimen: true },
    ...
    ComponentEntry { slug: "toggle", display_name: "Toggle", description: "Pressable toggle button.", tier: Tier::Primitive, has_specimen: true },
...
pub static COMPOSITES: &[ComponentEntry] = &[
    ...
    ComponentEntry { slug: "embed-shell", display_name: "EmbedShell", description: "Container for external content.", tier: Tier::Composite, has_specimen: true },
    ...
    ComponentEntry { slug: "grid-shell", display_name: "GridShell", description: "Grid layout browse view.", tier: Tier::Composite, has_specimen: true },
    ...
    ComponentEntry { slug: "list-shell", display_name: "ListShell", description: "List layout browse view.", tier: Tier::Composite, has_specimen: true },
    ...
    ComponentEntry { slug: "slug-field", display_name: "SlugField", description: "URL-safe slug field.", tier: Tier::Composite, has_specimen: true },
