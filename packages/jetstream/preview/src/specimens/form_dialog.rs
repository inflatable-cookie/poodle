...
pub fn render(theme: &JetstreamThemeProvider) -> El {
    ...
    div()
        ...
        .child(group(
            "Default (submit + cancel actions)",
            secondary,
            js_form_dialog(
                &FormDialogSpec::new("Create project"),
                theme,
                vec![
                    field("fd-project", "Project name", "Untitled project"),
                    field("fd-desc", "Description", "What is this for?"),
                ],
                None,
            ),
        ))
        .child(group(
            "With subtitle and error",
            secondary,
            js_form_dialog(
                ...
                theme,
                vec![
                    field("fd-title", "Title", "Track title"),
                    field("fd-artist", "Artist", "Artist name"),
                ],
                None,
            ),
        ))
        .child(group(
            "Submitting state (disabled)",
            secondary,
            js_form_dialog(
                &FormDialogSpec::new("Save changes").with_submitting(true),
                theme,
        ...
        .child(group(
            "No default actions (custom slot)",
            secondary,
            js_form_dialog(
                &FormDialogSpec::new("Custom actions").with_show_default_actions(false),
                theme,
                vec![field("fd-value", "Value", "Enter a value")],
                Some(js_form_actions(
