...
pub fn render(theme: &JetstreamThemeProvider) -> El {
    ...
    div()
        ...
        .child(group(
            ...
            div()
                ...
                .child(row(js_range_slider(
                    &RangeSliderSpec::new(45.0, 55.0).with_bounds(0.0, 100.0),
                    theme,
                )))
                .child(row(js_range_slider(
                    &RangeSliderSpec::new(0.0, 100.0).with_bounds(0.0, 100.0),
                    theme,
                )))
                .child(row(js_range_slider(
                    &RangeSliderSpec::new(0.0, 25.0).with_bounds(0.0, 100.0),
                    theme,
                )))
                .child(row(js_range_slider(
                    &RangeSliderSpec::new(75.0, 100.0).with_bounds(0.0, 100.0),
                    theme,
                ))),
        ))
        ...
        .child(group(
            "Custom min / max + step (0–500, step 50)",
            secondary,
            row(js_range_slider(
        ...
        .child(group(
            ...
            div()
                ...
                .gap(12.0)
                .child(row(js_range_slider(
                    &RangeSliderSpec::new(25.0, 75.0).with_density(ControlDensity::Compact),
                    theme,
                )))
                .child(row(js_range_slider(
                    &RangeSliderSpec::new(25.0, 75.0).with_density(ControlDensity::Default),
                    theme,
                )))
                .child(row(js_range_slider(
                    &RangeSliderSpec::new(25.0, 75.0).with_density(ControlDensity::Comfortable),
                    theme,
                ))),
        ))
}
