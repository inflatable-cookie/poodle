    ...
    div()
        ...
        .child(group(
            ...
            div()
                .flex_row()
                .gap(16.0)
                .child(div().w(rem_to_px(17.5)).child(js_card(
                    &CardSpec::new(),
                    theme,
                    vec![
                        title("Project Alpha"),
        ...
        .child(group(
            "Outlined variant",
            secondary,
            div().w(rem_to_px(17.5)).child(js_card(
                &CardSpec::new().with_variant(CardVariant::Outlined),
                theme,
                vec![
                    title("Outlined card"),
        ...
        .child(group(
            ...
            secondary,
            div().w(rem_to_px(17.5)).child(js_card(
                &CardSpec::new().with_variant(CardVariant::Elevated),
                theme,
                vec![
                    title("Elevated card"),
        ...
        .child(group(
            ...
            secondary,
            div().w(rem_to_px(17.5)).child(js_card(
                &CardSpec::new().with_layout(CardLayout::Compact),
                theme,
                vec![
