...
pub fn render(theme: &JetstreamThemeProvider) -> JsEl {
    ...
    div().flex_col().gap(24.0)
        ...
        .child(group("Legend + description", secondary,
            div().w(400.0)
                .child(js_field_set(
                    &FieldSetSpec::new()
                    ...
                    vec![
                        ...
                        field(theme, "fs-email", "Email", Some("We'll never share your email."), Some("jane@example.com")),
                    ],
                ))
        ))
        // Without legend
        .child(group("Without legend", secondary,
            div().w(400.0)
                .child(js_field_set(
                    ...
                    theme,
                    vec![
                        field(theme, "fs-street", "Street address", None, Some("123 Main St")),
        ...
        .child(group("Span (full)", secondary,
            div().w(400.0)
                .child(js_field_set(
                    ...
                    vec![
                        ...
                        js_field(
                            ...
                            theme,
                            Some(js_text_input(&TextInputSpec::new().with_placeholder("123 Main St"), theme)),
                        ),
        ...
        // Gap: none
        .child(group("Gap: none", secondary,
            div().w(400.0)
                .child(js_field_set(
                    &FieldSetSpec::new()
                    ...
                    theme,
                    vec![
                        field(theme, "fs4-line1", "Line 1", None, Some("Apartment, suite, etc.")),
                        field(theme, "fs4-line2", "Line 2", None, Some("Building, floor, etc.")),
                    ],
                ))
        ))
}
