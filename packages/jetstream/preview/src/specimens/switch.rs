    ...
    div()
        ...
        .child(group(
            ...
            div()
                ...
                .child(js_switch(
                    &sw(false, "Disabled off").with_disabled(true),
                    theme,
                ))
                .child(js_switch(
                    &sw(true, "Disabled on").with_disabled(true),
                    theme,
                ))
                .child(js_switch(
                    &sw(true, "Read-only on").with_read_only(true),
                    theme,
                )),
        ))
        ...
        .child(group(
            ...
            div()
                ...
                .gap(12.0)
                .child(js_switch(
                    &sw(true, "Compact").with_density(ControlDensity::Compact),
                    theme,
                ))
                .child(js_switch(
                    &sw(true, "Default").with_density(ControlDensity::Default),
                    theme,
                ))
                .child(js_switch(
                    &sw(true, "Comfortable").with_density(ControlDensity::Comfortable),
                    theme,
                )),
        ))
}
