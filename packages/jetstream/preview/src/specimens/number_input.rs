...
pub fn render(theme: &JetstreamThemeProvider) -> JsEl {
    ...
    div().flex_col().gap(24.0)
        ...
        .child(group("With steppers", secondary,
            div().w(300.0)
                .child(js_number_input(&NumberInputSpec::new(3.0).with_min(0.0).with_max(10.0).with_step(1.0).with_steppers(true), theme))
        ))
        // Sizes (xs–xl)
        .child(group("Sizes (xs–xl)", secondary,
            div().flex_col().gap(8.0)
                .child(div().w(300.0).child(js_number_input(&NumberInputSpec::new(50.0).with_size(ControlSize::Xs), theme)))
                .child(div().w(300.0).child(js_number_input(&NumberInputSpec::new(50.0).with_size(ControlSize::Sm), theme)))
                .child(div().w(300.0).child(js_number_input(&NumberInputSpec::new(50.0).with_size(ControlSize::Md), theme)))
                .child(div().w(300.0).child(js_number_input(&NumberInputSpec::new(50.0).with_size(ControlSize::Lg), theme)))
                .child(div().w(300.0).child(js_number_input(&NumberInputSpec::new(50.0).with_size(ControlSize::Xl), theme)))
        ))
        // Densities (compact / default / comfortable)
        .child(group("Densities", secondary,
            div().flex_col().gap(8.0)
                .child(div().w(300.0).child(js_number_input(&NumberInputSpec::new(50.0).with_density(ControlDensity::Compact), theme)))
                .child(div().w(300.0).child(js_number_input(&NumberInputSpec::new(50.0).with_density(ControlDensity::Default), theme)))
                .child(div().w(300.0).child(js_number_input(&NumberInputSpec::new(50.0).with_density(ControlDensity::Comfortable), theme)))
        ))
}
