...
use crate::compat::js_stack;
use crate::compat::{rem_to_px, size_font_rem};
use crate::nel::*;
use poodle_jetstream::JetstreamThemeProvider;

use poodle_specs::{
    Alignment, ControlSize, LayoutJustify, PaddingScale, StackDirection, StackSpec,
};
    ...
    div()
        ...
        .child(group(
            ...
            js_stack(
                &StackSpec::new(),
                theme,
                vec![item("Item 1"), item("Item 2"), item("Item 3")],
            ),
        ))
        .child(group(
            "Small gap",
            secondary,
            js_stack(
                &StackSpec::new().with_gap(PaddingScale::Sm),
                theme,
        ...
        .child(group(
            ...
            secondary,
            js_stack(
                &StackSpec::new().with_align(Alignment::Center),
                theme,
                vec![item("Centered"), item("Items")],
            ),
        ))
        .child(group(
            "Row direction",
