...
use crate::compat::js_audio_player;
use crate::nel::*;
    ...
    div()
        ...
        .child(group(
            ...
            div()
                ...
                .child(player(
                    theme,
                    sized(src).with_density(ControlDensity::Compact),
                ))
                .child(player(
                    theme,
                    sized(src).with_density(ControlDensity::Default),
                ))
                .child(player(
                    theme,
                    sized(src).with_density(ControlDensity::Comfortable),
                )),
        ))
...
fn player(theme: &JetstreamThemeProvider, spec: AudioPlayerSpec) -> El {
