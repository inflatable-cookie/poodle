    ...
    div()
        ...
        .child(group(
            ...
            row()
                .items_end()
                .child(js_pill(
                    &PillSpec::new().with_label("XS").with_size(PillSize::Xs),
                    theme,
                ))
                .child(js_pill(
                    &PillSpec::new().with_label("SM").with_size(PillSize::Sm),
                    theme,
                ))
                .child(js_pill(
                    &PillSpec::new().with_label("MD").with_size(PillSize::Md),
                    theme,
                ))
                .child(js_pill(
                    &PillSpec::new().with_label("LG").with_size(PillSize::Lg),
                    theme,
                ))
                .child(js_pill(
                    &PillSpec::new().with_label("XL").with_size(PillSize::Xl),
                    theme,
                )),
        ))
