...
pub fn render(tree: &mut UiTree, theme: &dyn ThemeProvider) -> UiNodeId {
    ...
    section_label(tree, root, "Standard Field", text_secondary);
    {
        ...
        let lbl = tree.create_node(Widget::Label { text: "Email address".to_string() }, pug_jetstream::map_layout(&LayoutIntent::new()),
        ...
        let desc = tree.create_node(Widget::Label { text: "We'll never share your email.".to_string() }, pug_jetstream::map_layout(&LayoutIntent::new()),
    ...
    section_label(tree, root, "Required Field", text_secondary);
    {
        ...
        let lbl_row = tree.create_node(Widget::Panel, pug_jetstream::map_layout(&LayoutIntent::new()
            .with_direction(LayoutDirection::Row)
            .with_gap(4.0)),
            NodeStyle::default());
        tree.add_child(field, lbl_row);

        let lbl = tree.create_node(Widget::Label { text: "Username".to_string() }, pug_jetstream::map_layout(&LayoutIntent::new()),
            NodeStyle { text_color: Some(text_primary), text_size: Some(12.0), ..NodeStyle::default() });
        tree.add_child(lbl_row, lbl);

        let req = tree.create_node(Widget::Label { text: "*".to_string() }, pug_jetstream::map_layout(&LayoutIntent::new()),
            NodeStyle { text_color: Some(danger), text_size: Some(12.0), ..NodeStyle::default() });
    ...
    section_label(tree, root, "Validation Error", text_secondary);
    {
        ...
        let lbl = tree.create_node(Widget::Label { text: "Password".to_string() }, pug_jetstream::map_layout(&LayoutIntent::new()),
            NodeStyle { text_color: Some(text_primary), text_size: Some(12.0), ..NodeStyle::default() });
        tree.add_child(field, lbl);
        ...
        let err = tree.create_node(Widget::Label { text: "Password must be at least 8 characters.".to_string() }, pug_jetstream::map_layout(&LayoutIntent::new()),
    ...
    section_label(tree, root, "Disabled Field", text_secondary);
    {
        ...
        let lbl = tree.create_node(Widget::Label { text: "Organization".to_string() }, pug_jetstream::map_layout(&LayoutIntent::new()),
            NodeStyle { text_color: Some(theme_bridge::tint(text_primary, 0.5)), text_size: Some(12.0), ..NodeStyle::default() });
        tree.add_child(field, lbl);
        ...
        let input = tree.create_node(Widget::Panel, pug_jetstream::map_layout(&LayoutIntent::new()
            ...
            NodeStyle { background: Some(theme_bridge::tint(bg_canvas, 0.5)), border_color: Some(border), border_width: 1.0, corner_radii: [6.0; 4], opacity: 0.5, ..NodeStyle::default() });
        tree.add_child(field, input);

        let val = tree.create_node(Widget::Label { text: "Acme Corp".to_string() }, pug_jetstream::map_layout(&LayoutIntent::new()),
            NodeStyle { text_color: Some(theme_bridge::tint(text_secondary, 0.5)), text_size: Some(12.0), ..NodeStyle::default() });
