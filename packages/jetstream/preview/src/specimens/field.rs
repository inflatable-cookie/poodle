    ...
    div()
        ...
        .child(group(
            ...
            div().w(300.0).child(js_field(
                ...
                theme,
                Some(js_text_input(
                    &TextInputSpec::new().with_placeholder("Acme Inc."),
                    theme,
                )),
            )),
        ))
        ...
        .child(group(
            ...
            div().w(300.0).child(js_field(
                ...
                theme,
                Some(js_text_input(
                    &TextInputSpec::new().with_placeholder("Jane Doe"),
                    theme,
                )),
            )),
        ))
        ...
        .child(group(
            ...
            div().w(300.0).child(js_field(
                ...
                theme,
                Some(js_text_input(
                    &TextInputSpec::new().with_placeholder("+1 (555) 000-0000"),
                    theme,
                )),
            )),
        ))
        ...
        .child(group(
            ...
            div().w(300.0).child(js_field(
                ...
                theme,
                Some(js_text_input(
                    &TextInputSpec::new().with_placeholder("sk_live_..."),
                    theme,
                )),
            )),
        ))
