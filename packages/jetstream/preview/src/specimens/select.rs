...
pub fn render(theme: &JetstreamThemeProvider) -> El {
    ...
    div()
        ...
        .child(group(
            "Default",
            secondary,
            div().w(240.0).child(js_select(
                &SelectSpec::new(options.clone())
                    .with_aria_label("Fruit 1")
                    .with_placeholder("Choose fruit..."),
                theme,
            )),
        ))
        // With value
        ...
        .child(group("Disabled", secondary, {
            let mut spec = SelectSpec::new(options.clone())
                .with_aria_label("Fruit 3")
                .with_value("apple");
        ...
        .child(group(
            "Grouped (open: headers + disabled option)",
            secondary,
            div().w(240.0).child(js_select(
                &SelectSpec::new(grouped_options.clone())
                    .with_aria_label("Fruit 8")
        ...
        .child(group(
            "Clearable (value selected → clear x)",
            secondary,
            div().w(240.0).child(js_select(
                &SelectSpec::new(options.clone())
                    .with_aria_label("Fruit 9")
        ...
        .child(group(
            "Selected + open (checkmark indicator)",
            secondary,
            div().w(240.0).child(js_select(
                &SelectSpec::new(options.clone())
                    .with_aria_label("Fruit 10")
                    .with_value("banana")
                    .with_open(true),
                theme,
            )),
        ...
        .child(group(
            ...
            div()
                ...
                .child(
                    div()
                        .w(240.0)
                        .child(js_select(&size_spec(&options, ControlSize::Xs), theme)),
                )
                .child(
                    div()
                        .w(240.0)
                        .child(js_select(&size_spec(&options, ControlSize::Sm), theme)),
                )
                .child(
                    div()
                        .w(240.0)
                        .child(js_select(&size_spec(&options, ControlSize::Md), theme)),
                )
                .child(
                    div()
                        .w(240.0)
                        .child(js_select(&size_spec(&options, ControlSize::Lg), theme)),
                )
                .child(
                    div()
                        .w(240.0)
                        .child(js_select(&size_spec(&options, ControlSize::Xl), theme)),
                ),
        ))
}
