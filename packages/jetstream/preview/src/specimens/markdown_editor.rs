...
use crate::compat::js_markdown_editor;
use crate::nel::*;
...
pub fn render(theme: &JetstreamThemeProvider) -> El {
    ...
    div()
        ...
        .child(group(
            ...
            secondary,
            js_markdown_editor(
                &MarkdownEditorSpec::new().with_placeholder("Write your content here..."),
                theme,
            ),
        ))
        .child(group(
...
fn group_with_status(title: &str, text_secondary: ColorValue, status: &str, content: El) -> El {
    div()
        .flex_col()
        .gap(8.0)
        .child(label(title).text_color(text_secondary).text_size(11.0))
