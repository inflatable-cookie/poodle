...
pub fn render(theme: &JetstreamThemeProvider) -> El {
    ...
    div().flex_col().gap(24.0)
        ...
        .child(group("Default (Grid selected)", secondary,
            div().w(300.0)
        ...
        .child(group("With disabled option (Draft)", secondary,
            div().w(340.0)
                .child(js_segmented_control(
        ...
        .child(group("Fully disabled", secondary,
            div().w(300.0)
                .child(js_segmented_control(
                    &{
                        let mut s = SegmentedControlSpec::new(view_options.clone())
        ...
        .child(group("Equal width (default)", secondary,
            div().w(360.0)
                .child(js_segmented_control(
        ...
        .child(group("Content fit (equalWidth=false)", secondary,
