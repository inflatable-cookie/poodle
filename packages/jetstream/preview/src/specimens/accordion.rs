...
use pug_jetstream_components::accordion::js_accordion;
        ...
        .child(group("Multiple selection", secondary,
            js_accordion(&AccordionSpec::new(vec![
                AccordionItemSpec {
                    ...
                    description: Some("Components consume semantic tokens like --pug-color-text-primary rather than hard-coded values.".into()),
                    is_disabled: false,
                },
                AccordionItemSpec {
                    value: "theming".into(),
