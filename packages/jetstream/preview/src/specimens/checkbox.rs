    ...
    div()
        ...
        .child(group(
            ...
            div()
                ...
                .gap(12.0)
                .child(js_checkbox(
                    &cb("Enable email notifications").with_checked(true),
                    theme,
                ))
                .child(js_checkbox(&cb("Subscribe to marketing emails"), theme))
                .child(js_checkbox(
                    &cb("I agree to the terms and conditions"),
                    theme,
                )),
        ))
        ...
        .child(group(
            ...
            div()
                ...
                .gap(12.0)
                .child(js_checkbox(
                    &cb("Disabled unchecked").with_disabled(true),
                    theme,
                ))
                .child(js_checkbox(
                    &cb("Disabled checked")
                ...
                .child(js_checkbox(
                    &cb("Mixed / indeterminate").with_mixed(true),
                    theme,
                ))
                .child(js_checkbox(
                    &cb("Read-only checked")
                        .with_checked(true)
                        .with_read_only(true),
                    theme,
                )),
        ...
        .child(group(
            ...
            div()
                ...
                .gap(12.0)
                .child(js_checkbox(
                    &cb("Compact").with_density(ControlDensity::Compact),
                    theme,
                ))
                .child(js_checkbox(
                    &cb("Default").with_density(ControlDensity::Default),
                    theme,
                ))
                .child(js_checkbox(
                    &cb("Comfortable").with_density(ControlDensity::Comfortable),
                    theme,
                )),
        ))
}
