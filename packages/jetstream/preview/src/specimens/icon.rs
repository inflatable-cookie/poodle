...
pub fn render(theme: &JetstreamThemeProvider) -> El {
    ...
    div()
        ...
        .child(group(
            "Sizes",
            secondary,
            render_sizes(theme, primary, secondary),
        ))
            ...
            div()
                ...
                .child(
                    div()
                        ...
                        .items_center()
                        .gap(8.0)
                        .child(div().text_color(primary).child(js_icon(
                            &IconSpec::new("search").with_aria_label("Search"),
                            theme,
                        )))
                        .child(
                            label("With aria-label \"Search\" — announced by screen readers")
                ...
                .child(
                    div()
                        ...
                        .child(
                            label("Without aria-label — decorative, hidden from assistive tech")
                                .text_color(secondary)
                                .text_size(11.0),
                        ),
                ),
        ...
        // --- Gallery ---
        .child(group(
            &format!("Gallery ({})", GALLERY_ICONS.len()),
            secondary,
...
fn render_sizes(theme: &JetstreamThemeProvider, primary: ColorValue, secondary: ColorValue) -> El {
    ...
    for &(size_label, size) in sizes {
        let mut row = div().flex_row().gap(16.0).items_center().child(
            label(size_label)
                .text_color(secondary)
                .text_size(11.0)
                .w(24.0),
...
fn color_cell(
    ...
    div()
        ...
        .child(
            div()
                .text_color(color)
                .child(js_icon(&IconSpec::new(icon), theme)),
        )
        ...
        gallery = gallery.child(
            div()
                ...
                .child(
                    div()
                        .text_color(primary)
                        .child(js_icon(&IconSpec::new(name), theme)),
                )
                .child(
                    label(name)
                        .text_color(secondary)
