    ...
    div()
        ...
        .child(group(
            ...
            div()
                ...
                .child(js_meter(
                    &MeterSpec::new().with_value(50.0).with_size(ControlSize::Sm),
                    theme,
                ))
                .child(js_meter(
                    &MeterSpec::new().with_value(50.0).with_size(ControlSize::Md),
                    theme,
                ))
                .child(js_meter(
                    &MeterSpec::new().with_value(50.0).with_size(ControlSize::Lg),
                    theme,
                ))
                .child(js_meter(
        ...
        .child(group(
            "Low value — 30% (within normal range)",
            secondary,
            div().w(300.0).child(js_meter(
                &MeterSpec::new()
                    .with_value(30.0)
        ...
        .child(group(
            "Custom range — 350 / 500 API calls used",
            secondary,
            div().w(300.0).child(js_meter(
                &MeterSpec::new()
                    .with_value(350.0)
