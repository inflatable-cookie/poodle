...
pub fn js_media_upload_status_panel(spec: &MediaUploadStatusPanelSpec, theme: &JetstreamThemeProvider) -> JsEl {
    ...
    let progress_height = rem_to_px(match effective_size {
        ...
        poodle_specs::ControlSize::Sm => 0.3125,
    ...
    let progress_max_width = rem_to_px(match effective_size {
        poodle_specs::ControlSize::Xs => 11.0,
        poodle_specs::ControlSize::Sm => 12.5,
        poodle_specs::ControlSize::Md => 14.0,
        poodle_specs::ControlSize::Lg => 15.5,
        poodle_specs::ControlSize::Xl => 17.0,
    });

    // Density-driven padding from contract
    let (final_pad_y, final_pad_x) = match spec.density {
        poodle_specs::ControlDensity::Compact => (rem_to_px(0.5), rem_to_px(0.5)),
        poodle_specs::ControlDensity::Default => (pad_y, pad_x),
        poodle_specs::ControlDensity::Comfortable => (rem_to_px(1.0), rem_to_px(1.0)),
    };
