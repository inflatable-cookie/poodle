...
/// DateTimePicker — a date popover with a time field.
///
...
impl DateTimePicker {
    pub fn from_spec(spec: DateTimePickerSpec, theme: &JetstreamThemeProvider) -> Self {
        Self {
            spec,
            theme: theme.clone(),
            on_toggle: None,
...
impl crate::element::IntoJsEl for DateTimePicker {
