...
use poodle_specs::{CheckState, TriStateSwitchSpec};
...
fn track_inset_rem(density: poodle_specs::ControlDensity) -> f32 {
    match density {
        poodle_specs::ControlDensity::Compact => 0.125,
        poodle_specs::ControlDensity::Default => 0.1875,
        poodle_specs::ControlDensity::Comfortable => 0.25,
    }
}
