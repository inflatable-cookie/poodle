...
pub fn js_editable_list(spec: &EditableListSpec, theme: &JetstreamThemeProvider) -> JsEl {
    ...
    let remove_size = rem_to_px(match effective_size {
        poodle_primitives::ControlSize::Xs => 1.0,
        poodle_primitives::ControlSize::Sm => 1.125,
        poodle_primitives::ControlSize::Md => 1.25,
        poodle_primitives::ControlSize::Lg => 1.375,
        poodle_primitives::ControlSize::Xl => 1.5,
    });
    let item_x = rem_to_px(match effective_size {
        poodle_primitives::ControlSize::Xs => 0.5,
        poodle_primitives::ControlSize::Sm => 0.625,
        poodle_primitives::ControlSize::Md => 0.625,
        poodle_primitives::ControlSize::Lg => 0.75,
        poodle_primitives::ControlSize::Xl => 0.875,
    });
    let add_x = rem_to_px(match effective_size {
        poodle_primitives::ControlSize::Xs => 0.625,
        poodle_primitives::ControlSize::Sm => 0.75,
        poodle_primitives::ControlSize::Md => 0.75,
        poodle_primitives::ControlSize::Lg => 0.875,
        poodle_primitives::ControlSize::Xl => 1.0,
    });

    // Density-driven spacing from contract
    let (list_gap, static_gap, item_y, add_gap) = match spec.density {
        poodle_primitives::ControlDensity::Compact => (0.375, 0.0625, 0.375, 0.25),
        poodle_primitives::ControlDensity::Default => (0.5, 0.125, 0.5, 0.375),
        poodle_primitives::ControlDensity::Comfortable => (0.625, 0.1875, 0.625, 0.5),
    };
