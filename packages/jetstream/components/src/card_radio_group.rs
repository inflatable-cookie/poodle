...
pub fn js_card_radio_group(spec: &CardRadioGroupSpec, theme: &JetstreamThemeProvider) -> JsEl {
    ...
    let indicator_size = rem_to_px(match effective_size {
        ...
        poodle_primitives::ControlSize::Md => 1.125,
        poodle_primitives::ControlSize::Lg => 1.25,
        poodle_primitives::ControlSize::Xl => 1.375,
    });
    let dot_size = rem_to_px(match effective_size {
        poodle_primitives::ControlSize::Xs => 0.25,
        poodle_primitives::ControlSize::Sm => 0.375,
    ...
    let title_font = rem_to_px(match effective_size {
        ...
        poodle_primitives::ControlSize::Sm => 0.8125,
        poodle_primitives::ControlSize::Md => 0.9375,
        poodle_primitives::ControlSize::Lg => 1.0625,
        poodle_primitives::ControlSize::Xl => 1.125,
    });
    let desc_font = rem_to_px(match effective_size {
        poodle_primitives::ControlSize::Xs => 0.6875,
        poodle_primitives::ControlSize::Sm => 0.75,
        poodle_primitives::ControlSize::Md => 0.8125,
        poodle_primitives::ControlSize::Lg => 0.875,
        poodle_primitives::ControlSize::Xl => 0.9375,
    });

    // Density-driven grid gap from contract
    let grid_gap = rem_to_px(match spec.density {
        poodle_primitives::ControlDensity::Compact => 0.5,
        poodle_primitives::ControlDensity::Default => 0.75,
        poodle_primitives::ControlDensity::Comfortable => 1.0,
    });
