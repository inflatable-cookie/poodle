...
pub fn js_block_editor(spec: &BlockEditorSpec, theme: &JetstreamThemeProvider) -> JsEl {
    ...
    let control_size = rem_to_px(match effective_size {
        ...
        poodle_specs::ControlSize::Lg => 2.0,
    ...
    let (shell_x, shell_y, stack_gap, toolbar_y, toolbar_x, content_x, content_y) = match spec.density {
        poodle_specs::ControlDensity::Compact => (0.625, 0.625, 0.375, 0.1875, 0.25, 0.375, 0.25),
        poodle_specs::ControlDensity::Default => (0.75, 0.75, 0.5, 0.25, 0.375, 0.5, 0.375),
        poodle_specs::ControlDensity::Comfortable => (1.0, 1.0, 0.625, 0.3125, 0.5, 0.625, 0.5),
    };
