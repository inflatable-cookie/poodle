...
pub fn js_video_player(spec: &VideoPlayerSpec, theme: &JetstreamThemeProvider) -> JsEl {
    ...
    let btn_size = rem_to_px(match effective_size {
        poodle_specs::ControlSize::Xs => 1.25,
        poodle_specs::ControlSize::Sm => 1.5,
        poodle_specs::ControlSize::Md => 1.75,
        poodle_specs::ControlSize::Lg => 2.125,
        poodle_specs::ControlSize::Xl => 2.25,
    });
    let icon_size = rem_to_px(match effective_size {
        poodle_specs::ControlSize::Xs => 0.75,
        poodle_specs::ControlSize::Sm => 0.875,
        poodle_specs::ControlSize::Md => 0.875,
        poodle_specs::ControlSize::Lg => 1.0,
        poodle_specs::ControlSize::Xl => 1.125,
    });
    let volume_width = rem_to_px(match effective_size {
        poodle_specs::ControlSize::Xs => 2.5,
        poodle_specs::ControlSize::Sm => 3.0,
        poodle_specs::ControlSize::Md => 3.5,
        poodle_specs::ControlSize::Lg => 4.0,
        poodle_specs::ControlSize::Xl => 4.5,
    });
    let time_font = rem_to_px(match effective_size {
        poodle_specs::ControlSize::Xs => 0.5625,
        poodle_specs::ControlSize::Sm => 0.625,
        poodle_specs::ControlSize::Md => 0.6875,
        poodle_specs::ControlSize::Lg => 0.75,
        poodle_specs::ControlSize::Xl => 0.8125,
    });
    let big_play_size = rem_to_px(match effective_size {
        poodle_specs::ControlSize::Xs => 3.0,
        poodle_specs::ControlSize::Sm => 3.5,
