...
//!
//! Contract: `docs/contracts/foundation/password-requirements.md`
...
use poodle_primitives::PasswordRequirementsSpec;
...
mod tests {
    use super::*;
    use poodle_primitives::PasswordRequirementsPolicy;
