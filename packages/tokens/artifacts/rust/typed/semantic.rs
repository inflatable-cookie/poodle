...
pub const COLOR_STATUS_INFO: ColorValue = ColorValue(0.17647058823529413, 0.5254901960784314, 0.9529411764705882, 1.0);
...
pub const COLOR_SYNTAX_COMMENT: ColorValue = ColorValue(0.615686274509804, 0.6980392156862745, 0.7764705882352941, 1.0);
pub const COLOR_SYNTAX_KEYWORD: ColorValue = ColorValue(0.788235294117647, 0.7176470588235294, 0.9921568627450981, 1.0);
pub const COLOR_SYNTAX_STRING: ColorValue = ColorValue(0.592156862745098, 0.8509803921568627, 0.6352941176470588, 1.0);
pub const COLOR_SYNTAX_LITERAL: ColorValue = ColorValue(0.9568627450980393, 0.7647058823529411, 0.47843137254901963, 1.0);
pub const COLOR_SYNTAX_TYPE: ColorValue = ColorValue(0.4980392156862745, 0.8392156862745098, 0.8627450980392157, 1.0);
pub const COLOR_SYNTAX_CALLABLE: ColorValue = ColorValue(0.5607843137254902, 0.7215686274509804, 1.0, 1.0);
pub const COLOR_SYNTAX_PROPERTY: ColorValue = ColorValue(0.9411764705882353, 0.6549019607843137, 0.7764705882352941, 1.0);
pub const COLOR_SYNTAX_OPERATOR: ColorValue = ColorValue(0.6823529411764706, 0.7372549019607844, 0.8117647058823529, 1.0);
pub const COLOR_SYNTAX_PUNCTUATION: ColorValue = ColorValue(0.596078431372549, 0.6784313725490196, 0.7450980392156863, 1.0);
pub const COLOR_SYNTAX_INVALID: ColorValue = ColorValue(1.0, 0.5607843137254902, 0.5254901960784314, 1.0);
...
pub const TYPOGRAPHY_CAPTION_WEIGHT: f32 = 500.0;
