...
describe("TimeZoneSelect (react)", () => {
  ...
  it("renders a searchable combobox with the default timezone placeholder", () => {
    const { container } = render(<TimeZoneSelect ariaLabel="Time zone" />);
  ...
  it("falls back to the default timezone list when options are empty", () => {
    const { container } = render(<TimeZoneSelect ariaLabel="Time zone" />);
  ...
  it("uses host-provided options and reports the picked value", () => {
  ...
  it("shows the pre-selected zone label on the trigger", () => {
    const { container } = render(<TimeZoneSelect defaultValue="America/New_York" ariaLabel="Time zone" />);
    expect(inputOf(container).value).toContain("America/New York");
  });

  it("disables the input when disabled", () => {
    const { container } = render(<TimeZoneSelect disabled ariaLabel="Time zone" />);
