...
export function RemediationBanner({
  ...
  return (
    <section className="poodle-remediation-banner" data-tone={tone} aria-labelledby={titleId} role={role} aria-live={ariaLive}>
      <span className="poodle-remediation-banner__icon" aria-hidden="true">
        {tone === "pending" ? <Spinner variant="ring" tone="accent" /> : <Icon name={toneIcon[tone]} />}
      </span>
