import "@inflatable-cookie/poodle-core/styles/list-card.css";
...
import { menuNavigableItems, registerDismissLayer, pointAnchor } from "@inflatable-cookie/poodle-core";
