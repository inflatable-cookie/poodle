...
const initial: ModMatrixCell[] = [{ sourceId: "one", destinationId: "a", amount: .75, enabled: true }, { sourceId: "one", destinationId: "b", amount: -.5, enabled: true }, { sourceId: "two", destinationId: "c", amount: 0, enabled: true }];
export function ModMatrixGridSpecimen() { const [cells] = useState(initial); return <Page>
  ...
  <Group title="Positive / negative / zero"><ModMatrixGrid sources={sources} destinations={destinations.slice(0, 2)} cells={cells} ariaLabel="Bipolar amounts" /></Group>
