  ...
  return (
    <div className="poodle-specimen">
      <SpecimenGroup label="Default (bottom-start)">
        <Popover ariaLabel="Quick settings" triggerIsInteractive trigger={<Button variant="secondary">Open popover</Button>}>
      ...
      <SpecimenGroup label="Top placement">
        <Popover placement="top" ariaLabel="Help tip" triggerIsInteractive trigger={<Button variant="secondary">Show help</Button>}>
          <div style={{ padding: "0.75rem", maxWidth: "16rem" }}>
            <p style={{ margin: 0, fontSize: "0.8125rem", color: "var(--poodle-color-text-secondary)" }}>
