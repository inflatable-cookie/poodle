...
export function WaveformDisplaySpecimen() { return (
    <SpecimenLayout
      variantDirection="row"
      sizes={(size) => <WaveformDisplay pyramid={pyramid} cursorSample={24} size={size} ariaLabel={`Waveform ${size} size`} />}
      densities={(density) => <WaveformDisplay pyramid={pyramid} cursorSample={24} density={density} ariaLabel={`Waveform ${density} density`} />}
    >
