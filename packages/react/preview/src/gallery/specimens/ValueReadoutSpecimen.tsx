...
export function ValueReadoutSpecimen() { return (
    <SpecimenLayout
      variantDirection="row"
      sizes={(size) => <ValueReadout value={-12.4} format={{ type: "db" }} size={size} ariaLabel={`Readout ${size} size`} />}
      densities={(density) => <ValueReadout value={-12.4} format={{ type: "db" }} density={density} ariaLabel={`Readout ${density} density`} />}
    >
