...
/**
 * g15.047 moved the Rust loader here so the window capture binary consumes the
 * same parser — still one parser per language, no third one. The g15.046
...
const RUST_LOADER = resolve(
  ROOT,
  "packages/gpui/preview/src/bin/window_capture/inventory.rs",
);
