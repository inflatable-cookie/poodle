...
const tokensCss = fileURLToPath(
  new URL("../../packages/core/src/tokens/generated/css/poodle-tokens.css", import.meta.url),
);
...
export default {
  ...
  resolve: {
    alias: [
      { find: "@inflatable-cookie/poodle-core/tokens/styles.css", replacement: tokensCss },
