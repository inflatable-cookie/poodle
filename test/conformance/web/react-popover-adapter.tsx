/** React Popover conformance adapter (g14.005). */
...
import { ReactPopoverHost } from "./hosts/ReactPopoverHost";

export class ReactPopoverAdapter implements RuntimeAdapter {
