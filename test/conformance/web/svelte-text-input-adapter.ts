/**
 * Svelte TextInput conformance adapter (g14.006). Mounts the real component
 * through a controlled host and drives insert/select/compose through DOM events.
 */
...
import TextInputHost from "./hosts/TextInputHost.svelte";
...
export class SvelteTextInputAdapter implements RuntimeAdapter {
  readonly runtime = "svelte";
  private _trace: TraceEntry[] = [];
  private host: ReturnType<typeof render<TextInputHost>> | null = null;
  private root: HTMLElement | null = null;

  mount(fixture: { props: Record<string, unknown>; regions: Record<string, string> }): void {
    this._trace = [];
    this.host = render(TextInputHost, {
      fixture,
