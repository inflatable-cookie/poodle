...
Canonical Poodle cards: task g16.053 (Git history),
task g16.054 (Git history)
...
Close the adoption row after Loophole's pin and rejection mapping merge. Promote CS20 only in Loophole/Pulse if stable
