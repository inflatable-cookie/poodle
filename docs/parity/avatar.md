...
<!-- pass 84: created + registered the Jetstream avatar specimen (was absent from
     specimens/mod.rs) — real js_avatar groups: initials fallback, image, shape, tone, size
     ladder. GPUI avatar specimen backfilled same coverage. Both previews build clean. gap→ok. -->
