...
created: 2026-08-31
updated: 2026-08-31
handoff_path: /Users/tom/Dev/projects/poodle/docs/handoffs/20260831-180208-paseo-project-settings.md
...
useful Paseo settings. This lane owns the poodle repository only.
...
- Poodle has `bootstrap:deps`, `qa`, `docs:check`, and `docs:dev`. Decide whether worktree setup needs `bootstrap:deps`; expose only shortcuts that are genuinely useful.
