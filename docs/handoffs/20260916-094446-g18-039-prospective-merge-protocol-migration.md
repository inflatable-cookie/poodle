---
title: g18.039 — Prospective-merge protocol migration
...
roadmap: docs/roadmaps/g18/039-prospective-merge-protocol-migration.md
...
Apply Northstar g03.020's accepted Queue manifest migration to Poodle.
...
Poodle main is clean and synchronized. The installed migration dry-run accepts
...
product code, releases, CI, Queue state, product planning, threads or
workspaces.
