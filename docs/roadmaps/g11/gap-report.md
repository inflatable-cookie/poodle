...
| Structural | No `--pug-surface` context propagation (surface-elevation pattern unimplemented) |
...
| Tokens | Radius/padding hardcoded. Min/max-width missing. Border wrong opacity. Shadow wrong. No `--pug-surface` equivalent |
