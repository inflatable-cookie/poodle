# g08.004 Input And Selection Component Fixes (Batch 2)
...
- [ ] Verify contract: `docs/contracts/foundation/text-area.md`
- [ ] Resolve padding, radius, row height from spec tokens

### number_entry

- [ ] Verify contract: `docs/contracts/foundation/number-entry.md`
- [ ] Resolve height, radius from spec tokens
- [ ] Wire stepper button click handlers

### radio_group

- [ ] Verify contract: `docs/contracts/foundation/radio-group.md`
- [ ] Resolve circle size, inner dot size, gap from spec tokens
- [ ] Wire per-option on-change handlers

### slider

- [ ] Verify contract: `docs/contracts/foundation/slider.md`
...
- [ ] Verify contract: `docs/contracts/foundation/segmented-control.md`
- [ ] Resolve outer/inner radius from spec tokens
- [ ] Replace hardcoded hover color with `color_mix`

### pin_input

- [ ] Verify contract: `docs/contracts/foundation/pin-input.md`
