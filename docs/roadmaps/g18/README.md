...
| [`g18.006`](006-v040-web-editor-release-and-desktop-unblock.md) — v0.4.0 web editor release candidate | paused | retained Queue task/workspace; resume after g18.011, g18.012, other blocking repairs and operator acceptance |
...
CodeEditor, RichTextEditor, and RichTextRenderer across both previews. g18.012
