...
| [`g18.012`](012-code-editor-extensible-language-registry.md) — CodeEditor extensible language registry | dependency-queued in parallel with g18.018→g18.020, ahead of g18.011 | consumer-selected lazy CodeMirror language providers; last planned product change before the sweep |
