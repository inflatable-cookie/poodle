...
| [`g18.006`](006-v040-web-editor-release-and-desktop-unblock.md) — v0.4.0 web editor release candidate | paused | retained Queue task/workspace; resume after g18.010–g18.017, other blocking repairs and operator acceptance |
...
| [`g18.010`](010-code-editor-editing-focus-treatment.md) — CodeEditor editing focus treatment | complete | PR #242 (merge `a71b48573c7253dfd45f35e482b9bbc7432ea0ca`); g18.011 stays held until g18.013–g18.017 merge, g18.006 stays blocked, g18.009 stays held |
| [`g18.011`](011-web-editor-ux-acceptance-sweep.md) — web editor UX acceptance sweep | Queue-held behind g18.013–g18.017 | paired Svelte/React sweep of CodeEditor, RichTextEditor and RichTextRenderer; operator release checkpoint |
...
with stable in-track crossover treatment across web and GPUI. g18.006 is paused
