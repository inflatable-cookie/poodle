...
- **State:** operator-paused in retained Queue task/workspace; resume only after
  g18.011 completes, g18.012 and every other blocking sweep repair merge, and
  the operator accepts the sweep; then rebase and recompute final-source identity
