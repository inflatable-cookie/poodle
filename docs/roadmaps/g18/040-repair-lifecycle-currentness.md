# g18.040 — Repair lifecycle currentness
...
Poodle has one mechanical lifecycle authority: no lifecycle-managed task file
...
- `docs/roadmaps/README.md` `Current state` names terminal task `g18.036`.
- `docs/roadmaps/README.md` `Current state` names terminal task `g18.037`.
- `docs/roadmaps/README.md` `Current state` names terminal task `g18.038`.
- `duplicate-status-header` in `docs/roadmaps/g18/038-tabs-cross-window-bridge-distribution-repair.md` (`g18.038`).
