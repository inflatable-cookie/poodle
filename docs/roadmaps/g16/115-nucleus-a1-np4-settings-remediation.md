# g16.115 — Nucleus A1 Tranche NP-4 Settings And Remediation

Status: complete — merged in PR #222 at `51b820a5d`
...
RadioGroup, Switch (receipted in `111`), TextInput, Callout, ConfirmAction, DetailItem (6 rows, 5 new)
