...
Primary repos: `pug`, downstream Loophole-owned repos

## Goals

- [x] prove that Loophole can consume Pug foundations without forcing DAW
  widgets into Pug core
- [x] harden the extension contract between Pug and app-specific workstation or
  DAW kits

## Execution Checklist

- [x] validate Loophole-facing foundation adoption
- [x] confirm DAW widgets remain outside Pug core
...
- kept the DAW boundary explicit by naming the downstream-owned widget families that remain outside Pug core
