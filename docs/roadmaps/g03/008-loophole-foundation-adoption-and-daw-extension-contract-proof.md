...
Primary repos: `poodle`, downstream Loophole-owned repos

## Goals

- [x] prove that Loophole can consume Poodle foundations without forcing DAW
  widgets into Poodle core
- [x] harden the extension contract between Poodle and app-specific workstation or
  DAW kits

## Execution Checklist

- [x] validate Loophole-facing foundation adoption
- [x] confirm DAW widgets remain outside Poodle core
...
- kept the DAW boundary explicit by naming the downstream-owned widget families that remain outside Poodle core
