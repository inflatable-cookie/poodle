...
| Context providers | — | IconProvider closed by `g15.009` (`packages/render/src/icon_provider.rs`); UiPresentationProvider remains a declared capability absence until architecture 010's construction-time cascade lands | — | `g15.043` ready; atomic Rust migration approved 2026-08-23 |
