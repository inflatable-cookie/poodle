...
| --- | --- | --- | --- | --- | --- | --- |
| `Accordion` | complete | complete | `missing` — smoke only | `AccordionSpec` (`packages/contracts/components/src/accordion.rs`) | `packages/render/src/accordion.rs` | `packages/gpui/preview/src/specimens/accordion.rs` |
...
| `AudioPlayer` | complete | complete | `missing` — smoke only | `AudioPlayerSpec` (`packages/contracts/components/src/audio_player.rs`) | `packages/render/src/audio_player.rs` | `packages/gpui/preview/src/specimens/audio_player_specimen.rs` |
| `AlertDialog` | complete | complete | `missing` — smoke only | `AlertDialogSpec` (`packages/contracts/components/src/alert_dialog.rs`) | `packages/render/src/alert_dialog.rs` | `packages/gpui/preview/src/specimens/alert_dialog.rs` |
| `Avatar` | complete | complete | `missing` — smoke only | `AvatarSpec` (`packages/contracts/components/src/avatar.rs`) | `packages/render/src/avatar.rs` | `missing` |
| `Box` | complete | complete | `missing` — smoke only | `BoxSpec` (`packages/contracts/components/src/box.rs`) | `packages/render/src/bx.rs` | `packages/gpui/preview/src/specimens/bx.rs` |
| `Breadcrumbs` | complete | complete | `missing` — smoke only | `BreadcrumbsSpec` (`packages/contracts/components/src/breadcrumbs.rs`) | `packages/render/src/breadcrumbs.rs` | `packages/gpui/preview/src/specimens/breadcrumbs_specimen.rs` |
| `BulkActionBar` | complete | complete | `missing` — smoke only | `BulkActionBarSpec` (`packages/contracts/components/src/bulk_action_bar.rs`) | `packages/render/src/bulk_action_bar.rs` | `packages/gpui/preview/src/specimens/bulk_action_bar_specimen.rs` |
...
| `Callout` | complete | complete | `missing` — smoke only | `CallOutSpec` (`call_out.rs`, documented rename) | `packages/render/src/callout.rs` | `missing` |
...
| `Card` | complete | complete | `missing` — smoke only | `CardSpec` (`packages/contracts/components/src/card.rs`) | `packages/render/src/card.rs` | `packages/gpui/preview/src/specimens/card_specimen.rs` |
| `Code` | complete | complete | `missing` — smoke only | `CodeSpec` (`packages/contracts/components/src/code.rs`) | `packages/render/src/code.rs` | `packages/gpui/preview/src/specimens/code.rs` |
| `ColorPicker` | complete | complete | `missing` — smoke only | `ColorPickerSpec` (`packages/contracts/components/src/color_picker.rs`) | `packages/render/src/color_picker.rs` | `packages/gpui/preview/src/specimens/color_picker.rs` |
...
| `Calendar` | complete | complete | `missing` — smoke only | `CalendarSpec` (`packages/contracts/components/src/calendar.rs`) | `packages/render/src/calendar.rs` | `packages/gpui/preview/src/specimens/calendar.rs` |
...
| `CollapseToggle` | complete | complete | `missing` — smoke only | `CollapseToggleSpec` (`packages/contracts/components/src/collapse_toggle.rs`) | `packages/render/src/collapse_toggle.rs` | `packages/gpui/preview/src/specimens/collapse_toggle.rs` |
| `Collapsible` | complete | complete | `missing` — smoke only | `CollapsibleSpec` (`packages/contracts/components/src/collapsible.rs`) | `packages/render/src/collapsible.rs` | `packages/gpui/preview/src/specimens/collapsible.rs` |
| `DetailItem` | complete | complete | `missing` — smoke only | `DetailItemSpec` (`packages/contracts/components/src/detail_item.rs`) | `packages/render/src/detail_item.rs` | `packages/gpui/preview/src/specimens/detail_item_specimen.rs` |
| `DatePicker` | complete | complete | `missing` — smoke only | `DatePickerSpec` (`packages/contracts/components/src/date_picker.rs`) | `packages/render/src/date_picker.rs` | `packages/gpui/preview/src/specimens/date_picker.rs` |
| `DateRangePicker` | complete | complete | `missing` — smoke only | `DateRangePickerSpec` (`packages/contracts/components/src/date_range_picker.rs`) | `packages/render/src/date_range_picker.rs` | `packages/gpui/preview/src/specimens/date_range_picker.rs` |
| `DateTimePicker` | complete | complete | `missing` — smoke only | `DateTimePickerSpec` (`packages/contracts/components/src/date_time_picker.rs`) | `packages/render/src/date_time_picker.rs` | `packages/gpui/preview/src/specimens/date_time_picker.rs` |
| `DateTimeRangePicker` | complete | complete | `missing` — smoke only | `DateTimeRangePickerSpec` (`packages/contracts/components/src/date_time_range_picker.rs`) | `packages/render/src/date_time_range_picker.rs` | `packages/gpui/preview/src/specimens/date_time_range_picker.rs` |
...
| `DurationInput` | complete | complete | `missing` — smoke only | `DurationInputSpec` (`packages/contracts/components/src/duration_input.rs`) | `packages/render/src/duration_input.rs` | `packages/gpui/preview/src/specimens/duration_input_specimen.rs` |
| `EditableLabel` | complete | complete | `missing` — smoke only | `EditableLabelSpec` (`packages/contracts/components/src/editable_label.rs`) | `packages/render/src/editable_label.rs` | `packages/gpui/preview/src/specimens/editable_label.rs` |
| `Eyebrow` | complete | complete | `missing` — smoke only | `EyebrowSpec` (`packages/contracts/components/src/eyebrow.rs`) | `packages/render/src/eyebrow.rs` | `packages/gpui/preview/src/specimens/eyebrow.rs` |
| `Field` | complete | complete | `missing` — smoke only | `FieldSpec` (`packages/contracts/components/src/field.rs`) | `packages/render/src/field.rs` | `packages/gpui/preview/src/specimens/field.rs` |
| `FieldSet` | complete | complete | `missing` — smoke only | `FieldSetSpec` (`packages/contracts/components/src/field_set.rs`) | `packages/render/src/field_set.rs` | `packages/gpui/preview/src/specimens/field_set_specimen.rs` |
...
| `FormActions` | complete | complete | `missing` — smoke only | `FormActionsSpec` (`packages/contracts/components/src/form_actions.rs`) | `packages/render/src/form_actions.rs` | `packages/gpui/preview/src/specimens/form_actions.rs` |
| `Grid` | complete | complete | `missing` — smoke only | `GridSpec` (`packages/contracts/components/src/grid.rs`) | `packages/render/src/grid.rs` | `packages/gpui/preview/src/specimens/grid.rs` |
| `HoverCard` | complete | complete | `missing` — smoke only | `HoverCardSpec` (`packages/contracts/components/src/hover_card.rs`) | `packages/render/src/hover_card.rs` | `packages/gpui/preview/src/specimens/hover_card.rs` |
...
| `IconButton` | complete | complete | `missing` — smoke only | `IconButtonSpec` (`packages/contracts/components/src/icon_button.rs`) | `packages/render/src/icon_button.rs` | `packages/gpui/preview/src/specimens/icon_button.rs` |
...
| `Meter` | complete | complete | `missing` — smoke only | `MeterSpec` (`packages/contracts/components/src/meter.rs`) | `packages/render/src/meter.rs` | `packages/gpui/preview/src/specimens/meter.rs` |
...
| `ListCardCounter` | complete | complete | `missing` — smoke only | `ListCardCounterSpec` (`packages/contracts/components/src/list_card_counter.rs`) | `packages/render/src/list_card_counter.rs` | `packages/gpui/preview/src/specimens/list_card_counter.rs` |
| `ListGrid` | complete | complete | `missing` — smoke only | `ListGridSpec` (`packages/contracts/components/src/list_grid.rs`) | `packages/render/src/list_grid.rs` | `packages/gpui/preview/src/specimens/list_grid.rs` |
...
| `MetaBar` | complete | complete | `missing` — smoke only | `MetaBarSpec` (`packages/contracts/components/src/meta_bar.rs`) | `packages/render/src/meta_bar.rs` | `packages/gpui/preview/src/specimens/meta_bar.rs` |
| `MetaItem` | complete | complete | `missing` — smoke only | `MetaItemSpec` (`packages/contracts/components/src/meta_item.rs`) | `packages/render/src/meta_item.rs` | `missing` |
| `NumberInput` | complete | complete | `missing` — smoke only | `NumberInputSpec` (`packages/contracts/components/src/number_input.rs`) | `packages/render/src/number_input.rs` | `packages/gpui/preview/src/specimens/number_input.rs` |
...
| `NavCard` | complete | complete | `missing` — smoke only | `NavCardSpec` (`packages/contracts/components/src/nav_card.rs`) | `packages/render/src/nav_card.rs` | `packages/gpui/preview/src/specimens/nav_card.rs` |
...
| `Pill` | complete | complete | `missing` — smoke only | `PillSpec` (`packages/contracts/components/src/pill.rs`) | `packages/render/src/pill.rs` | `missing` |
...
| `Pagination` | complete | complete | `missing` — smoke only | `PaginationSpec` (`packages/contracts/components/src/pagination.rs`) | `packages/render/src/pagination.rs` | `packages/gpui/preview/src/specimens/pagination.rs` |
| `PaginationSummary` | complete | complete | `missing` — smoke only | `PaginationSummarySpec` (`packages/contracts/components/src/pagination_summary.rs`) | `packages/render/src/pagination_summary.rs` | `packages/gpui/preview/src/specimens/pagination_summary_specimen.rs` |
| `PasswordRequirements` | complete | complete | `missing` — smoke only | `PasswordRequirementsSpec` (`packages/contracts/components/src/password_requirements.rs`) | `packages/render/src/password_requirements.rs` | `packages/gpui/preview/src/specimens/password_requirements.rs` |
| `Progress` | complete | complete | `missing` — smoke only | `ProgressSpec` (`packages/contracts/components/src/progress.rs`) | `packages/render/src/progress.rs` | `packages/gpui/preview/src/specimens/progress.rs` |
| `Radio` | complete | complete | `missing` — smoke only | `missing` | `missing` | `missing` |
...
| `RadioGroup` | complete | complete | `missing` — smoke only | `RadioGroupSpec` (`packages/contracts/components/src/radio_group.rs`) | `packages/render/src/radio_group.rs` | `packages/gpui/preview/src/specimens/radio_group.rs` |
| `Rating` | complete | complete | `missing` — smoke only | `RatingSpec` (`packages/contracts/components/src/rating.rs`) | `packages/render/src/rating.rs` | `packages/gpui/preview/src/specimens/rating.rs` |
| `Region` | complete | complete | `missing` — smoke only | `RegionSpec` (`packages/contracts/components/src/region.rs`) | `packages/render/src/region.rs` | `packages/gpui/preview/src/specimens/region.rs` |
| `ResizeHandle` | complete | complete | `missing` — smoke only | `ResizeHandleSpec` (`packages/contracts/components/src/resize_handle.rs`) | `packages/render/src/resize_handle.rs` | `packages/gpui/preview/src/specimens/resize_handle.rs` |
...
| `SegmentedControl` | complete | complete | `missing` — smoke only | `SegmentedControlSpec` (`packages/contracts/components/src/segmented_control.rs`) | `packages/render/src/segmented_control.rs` | `packages/gpui/preview/src/specimens/segmented_control.rs` |
...
| `ScrollShell` | complete | complete | `missing` — smoke only | `ScrollShellSpec` (`packages/contracts/components/src/scroll_shell.rs`) | `packages/render/src/scroll_shell.rs` | `packages/gpui/preview/src/specimens/scroll_shell.rs` |
| `Separator` | complete | complete | `missing` — smoke only | `SeparatorSpec` (`packages/contracts/components/src/separator.rs`) | `packages/render/src/separator.rs` | `packages/gpui/preview/src/specimens/separator.rs` |
...
| `Skeleton` | complete | complete | `missing` — smoke only | `SkeletonSpec` (`packages/contracts/components/src/skeleton.rs`) | `packages/render/src/skeleton.rs` | `packages/gpui/preview/src/specimens/skeleton.rs` |
| `Slider` | complete | complete | `missing` — smoke only | `SliderSpec` (`packages/contracts/components/src/slider.rs`) | `packages/render/src/slider.rs` | `packages/gpui/preview/src/specimens/slider.rs` |
| `Spinner` | complete | complete | `missing` — smoke only | `SpinnerSpec` (`packages/contracts/components/src/spinner.rs`) | `packages/render/src/spinner.rs` | `missing` |
| `Spacer` | complete | complete | `missing` — smoke only | `SpacerSpec` (`packages/contracts/components/src/spacer.rs`) | `packages/render/src/spacer.rs` | `packages/gpui/preview/src/specimens/spacer.rs` |
| `Stack` | complete | complete | `missing` — smoke only | `StackSpec` (`packages/contracts/components/src/stack.rs`) | `packages/render/src/stack.rs` | `packages/gpui/preview/src/specimens/stack.rs` |
| `Stepper` | complete | complete | `missing` — smoke only | `StepperSpec` (`packages/contracts/components/src/stepper.rs`) | `packages/render/src/stepper.rs` | `packages/gpui/preview/src/specimens/stepper.rs` |
