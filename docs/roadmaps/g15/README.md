...
`g15.011` partial with bounded continuation cards; `g15.016` next for review
...
13. [016 — Specimen idiom convergence](016-specimen-idiom-convergence.md) — next for orchestrator review
...
Review `g15.016` for readiness; do not dispatch it until its exact page scope
and acceptance evidence are confirmed. `g15.011` remains partial until `g15.026` and
