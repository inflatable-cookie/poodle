...
Primary repos: `poodle`, downstream consumers

## Context

`g01` should not close with only component ideas. It needs explicit rules for
how parity is evidenced and how downstream repos extend Poodle without bloating
it.
...
- [x] define what qualifies Poodle to move into broader composite and adoption work
