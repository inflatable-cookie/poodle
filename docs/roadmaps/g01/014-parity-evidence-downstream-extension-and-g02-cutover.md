...
Primary repos: `flint`, downstream consumers

## Context

`g01` should not close with only component ideas. It needs explicit rules for
how parity is evidenced and how downstream repos extend Flint without bloating
it.
...
- [x] define what qualifies Flint to move into broader composite and adoption work
