# g04.009 GPUI Workstation Shell, Command Discovery, And Layout Orchestration Parity

Status: completed
Owner: Pug Core
Updated: 2026-03-12
Depends on: g04.003, g04.006, g04.008
Primary repos: `pug`
...
- updated release metadata, package surfaces, and roadmap status so the repo now points at `g04.010`
