...
- [ ] evaluate the Nightfire block editor architecture for portability to Pug
- [ ] define the scope and contract for a Pug block editor component
...
- [ ] determine whether Pug block editor should wrap an existing engine
