...
- [ ] implement TextInput prefix/suffix slots in `@flint/svelte-primitives`
...
- [ ] implement InlineEditableField composite in `@flint/svelte-composites`
- [ ] write contract for SlugField: source text binding, slug preview,
  manual override, validation
- [ ] implement SlugField composite in `@flint/svelte-composites`
- [ ] amend Field contract: add `span` prop for CSS grid column spanning
- [ ] implement Field grid-spanning in `@flint/svelte-primitives`
