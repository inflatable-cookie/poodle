...
- [`g18`](g18/README.md) — GPUI functional completion
  ...
  - Active task: `g18.013` RichTextEditor toolbar controls; `g18.015` preview
    ...
    reconfiguration are ready in parallel. `g18.011` stays held until
    g18.013–g18.016 merge.
  ...
  - Paused candidate: retained g18.006 task/workspace resumes only after
    g18.010–g18.016, all other blocking repairs, and operator sweep acceptance.
  ...
  - Next checkpoint: merge g18.013, complete g18.014–g18.016,
