...
- `g15`
  ...
  - Next: complete the `g15.021` review loop. `g15.035` is ready as a
    parallel-safe additive API lane and must land before `g15.012`/`g15.013`.
    Then continue the bounded specimen program.
