...
- [`g18`](g18/README.md) — GPUI functional completion
  ...
  - Active tasks: `g18.013` RichTextEditor toolbar controls; `g18.017`
    ...
    behind g18.013. `g18.011` is dependency-queued behind g18.013, g18.014,
    g18.017, g18.018 and g18.019.
  - Queued task: `g18.011` four-surface web editor UX acceptance sweep,
    dependency-ordered behind all five open product prerequisites.
