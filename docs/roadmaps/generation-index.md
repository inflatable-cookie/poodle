...
- [`g18`](g18/README.md) — GPUI functional completion
  ...
  - Active tasks: `g18.017`
    block Slider fixed inline presentation; `g18.019` MarkdownRenderer shared
    safe/trusted rendering.
  ...
  - Queued task: `g18.011` four-surface web editor UX acceptance sweep,
    dependency-ordered behind all four open product prerequisites.
  ...
  - Ready task: `g18.018` RichTextEditor controlled-echo selection
    ...
    g18.011 is released.
  - Active task: `g18.019` MarkdownRenderer shared safe/trusted rendering,
    Queue task `eac944cd-2ee0-4810-bd60-0976e3270e56`, required before g18.011.
  ...
  - Next checkpoint: complete g18.014 and g18.017–g18.019,
