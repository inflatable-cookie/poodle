...
- [`g18`](g18/README.md) — GPUI functional completion
  ...
  - Merged repair: `g18.015` preview distribution build preflight (PR
    ...
    before Vite listens.
  - Ready task: `g18.016` CodeEditor live line-number reconfiguration, parallel
    and required before g18.011 is released.
  ...
  - Paused candidate: retained g18.006 task/workspace resumes only after
    g18.010–g18.017, all other blocking repairs, and operator sweep acceptance.
  ...
  - Next checkpoint: merge g18.013, complete g18.014, g18.016 and g18.017,
