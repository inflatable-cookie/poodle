...
- `g15`
  - Status: active — `g15.001`–`g15.010` and `g15.014`–`g15.016`
    complete; `g15.011` partial with bounded continuation cards; `g15.017`
    next;
    `g15.013` final
  ...
  - Next: re-baseline and ready `g15.017`, then continue the bounded specimen
    ...
    caption idiom and added two dedicated pages. The web release roster reads 175/175 focused
