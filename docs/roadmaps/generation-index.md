...
- [`g18`](g18/README.md) — GPUI functional completion
  ...
  - Next checkpoint: finish g18.011 while g18.022 runs and dispatch g18.023;
    get operator acceptance, merge required repairs, then resume g18.006.
