...
- [`g18`](g18/README.md) — GPUI functional completion
  ...
  - Active task: `g18.013` RichTextEditor toolbar controls; `g18.015` preview
    distribution build preflight and `g18.016` CodeEditor live line-number
    reconfiguration are ready in parallel; `g18.017` block Slider fixed inline
    presentation is also ready. `g18.011` stays held until g18.013–g18.017
    merge.
  ...
  - Next checkpoint: merge g18.013, complete g18.014–g18.017,
