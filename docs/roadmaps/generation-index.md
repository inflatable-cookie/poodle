...
- `g16`
  ...
  - Range: `001` closed; `002` closed — partial outcome; `003` merged in PR #77;
    ...
    `019` planned with entry gate cleared
  ...
  - Next move: publish the worker handoff for recompiled `g16.019`, then
    dispatch the bounded mounted-overlay lane. NumberInput, EditableLabel,
