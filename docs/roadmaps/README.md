...
- `g15` is the release-first v0.2.0 runway. The release-baseline roster and
  first focused-evidence tranche are complete; PR #27 (`g15.003`) and PR #26
  (`g15.004`) have changes requested. Jetstream remains deferred.
...
- `g15` — active v0.2.0 release baseline; `g15.003` and `g15.004` in parallel
  review repair
