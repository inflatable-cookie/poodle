...
- `g15` is the release-first v0.2.0 runway. The release-baseline roster and
  first focused-evidence tranche are complete; `g15.003` is in progress and
  `g15.004` is ready for parallel dispatch. Jetstream remains deferred.
...
- `g15` — active v0.2.0 release baseline; `g15.003` in progress and
  `g15.004` ready in parallel
