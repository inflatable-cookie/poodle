...
Poodle should follow the same general planning posture used in the denser Chorus
...
Poodle has more limited scope than Loophole, so its generations can be somewhat
