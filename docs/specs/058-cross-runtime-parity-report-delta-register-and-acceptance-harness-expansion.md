...
Carry this explicit cross-runtime report into `g04.012` and prove GPUI
adoption through a downstream reference app or equivalent multi-app
implementation evidence instead of treating artifact-backed parity as the end
state.
