...
Freeze how canonical Pug tokens may change over time so downstream consumers,
...
Pug should prefer alias-plus-deprecation sequences over abrupt removal wherever
