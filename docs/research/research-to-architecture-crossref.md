...
|-------------------|---------------------|--------|------------------|
| [hub-gpui](./source-hubs/hub-gpui.md) | [architecture/001-pug-system-shape.md](../architecture/001-pug-system-shape.md) | 🟢 complete | [tm-token-system](./translation-memos/tm-token-system.md) |
| [hub-bits](./source-hubs/hub-bits.md) | [architecture/001-pug-system-shape.md](../architecture/001-pug-system-shape.md) | 🟢 complete | [tm-svelte-substrate](./translation-memos/tm-svelte-substrate.md) |
...
2. Update architecture/001-pug-system-shape.md with research decisions
