...
(task g13.020 (Git history)) retired the vocabulary
...
(the g13 `pilot-verdict-evidence` record (Git history)). This spec is narrowed
...
the g13 `pilot-verdict-evidence` record (Git history).
