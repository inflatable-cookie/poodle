...
- `docs/knowledge/specs/archive/002-component-contract-template-and-parity-rules.md`
- `docs/knowledge/specs/archive/007-underlay-bridge-and-wrapper-preservation-rules.md`
- `docs/contracts/components/README.md`
- `docs/contracts/components/README.md`
- `docs/contracts/workstation/README.md`
- the g01.013 log (Git history)
