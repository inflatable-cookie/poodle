# Agent Local Paths and Manual Worktree Locations

Status: active
Owner: Poodle core
Updated: 2026-08-16
Depends on: `docs/knowledge/contracts/working-rules.md`
Affects: `AGENTS.md` and manual worker launch procedures
...
Each worker brief states whether its worktree is harness-managed or manual.
