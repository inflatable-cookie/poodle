...
|-------|----------|-------|
| `invalid` | `border-color` | `var(--poodle-color-status-danger)` |
| `valid` | `border-color` | `var(--poodle-color-status-success)` |
| `pending` | `border-color` | `var(--poodle-color-accent-base)` |
...
- expected crate/module surface: `poodle_gpui::primitives::number_entry`
