...
| Part | Token | Purpose |
|------|-------|---------|
| Root | `--pug-color-text-secondary` | default text and icon color |
| Root (hover, linked) | `--pug-color-text-primary` | hover text and icon color for linked counters |
...
- Expected crate/module surface: `pug_gpui::primitives::list_card_counter`
