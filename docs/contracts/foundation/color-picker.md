...
| Property | Value |
|----------|-------|
| `background` | `linear-gradient(to right, transparent, var(--pug-cp-alpha-color)), repeating-conic-gradient(checkerboard)` |
| fill | hidden |
...
- expected crate/module surface: `pug_gpui::primitives::color_picker`
